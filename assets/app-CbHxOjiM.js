import{f as ie,c as Pe,r as c,s as Ft,a as At,p as da,v as pa,i as ha,b as xa,d as ua,e as ma,n as Wt,g as ga,h as fa,u as Pt,j as ya,m as $e,k as $t,l as re,M as ba,o as e,q as p,C as L,A as q,t as wa,w as va}from"./ConductorModeSection-BtdcXbmG.js";function Rt(t,a){let s;const o=()=>{const{currentTime:n}=a,r=(n===null?0:n.value)/100;s!==r&&t(r),s=r};return ie.preUpdate(o,!0),()=>Pe(o)}function ja(t,a,s){c.useInsertionEffect(()=>t.on(a,s),[t,a,s])}function be(t){return typeof window>"u"?!1:t?Ft():At()}const ka=50,at=()=>({current:0,offset:[],progress:0,scrollLength:0,targetOffset:0,targetLength:0,containerLength:0,velocity:0}),Na=()=>({time:0,x:at(),y:at()}),Sa={x:{length:"Width",position:"Left"},y:{length:"Height",position:"Top"}};function st(t,a,s,o){const n=s[a],{length:i,position:r}=Sa[a],l=n.current,d=s.time;n.current=Math.abs(t[`scroll${r}`]),n.scrollLength=t[`scroll${i}`]-t[`client${i}`],n.offset.length=0,n.offset[0]=0,n.offset[1]=n.scrollLength,n.progress=da(0,n.scrollLength,n.current);const h=o-d;n.velocity=h>ka?0:pa(n.current-l,h)}function Ca(t,a,s){st(t,"x",a,s),st(t,"y",a,s),a.time=s}function za(t,a){const s={x:0,y:0};let o=t;for(;o&&o!==a;)if(ha(o))s.x+=o.offsetLeft,s.y+=o.offsetTop,o=o.offsetParent;else if(o.tagName==="svg"){const n=o.getBoundingClientRect();o=o.parentElement;const i=o.getBoundingClientRect();s.x+=n.left-i.left,s.y+=n.top-i.top}else if(o instanceof SVGGraphicsElement){const{x:n,y:i}=o.getBBox();s.x+=n,s.y+=i;let r=null,l=o.parentNode;for(;!r;)l.tagName==="svg"&&(r=l),l=o.parentNode;o=r}else break;return s}const Re={start:0,center:.5,end:1};function ot(t,a,s=0){let o=0;if(t in Re&&(t=Re[t]),typeof t=="string"){const n=parseFloat(t);t.endsWith("px")?o=n:t.endsWith("%")?t=n/100:t.endsWith("vw")?o=n/100*document.documentElement.clientWidth:t.endsWith("vh")?o=n/100*document.documentElement.clientHeight:t=n}return typeof t=="number"&&(o=a*t),s+o}const La=[0,0];function Ta(t,a,s,o){let n=Array.isArray(t)?t:La,i=0,r=0;return typeof t=="number"?n=[t,t]:typeof t=="string"&&(t=t.trim(),t.includes(" ")?n=t.split(" "):n=[t,Re[t]?t:"0"]),i=ot(n[0],s,o),r=ot(n[1],a),i-r}const le={Enter:[[0,1],[1,1]],Exit:[[0,0],[1,0]],Any:[[1,0],[0,1]],All:[[0,0],[1,1]]},Ma={x:0,y:0};function Ea(t){return"getBBox"in t&&t.tagName!=="svg"?t.getBBox():{width:t.clientWidth,height:t.clientHeight}}function Ia(t,a,s){const{offset:o=le.All}=s,{target:n=t,axis:i="y"}=s,r=i==="y"?"height":"width",l=n!==t?za(n,t):Ma,d=n===t?{width:t.scrollWidth,height:t.scrollHeight}:Ea(n),h={width:t.clientWidth,height:t.clientHeight};a[i].offset.length=0;let m=!a[i].interpolate;const x=o.length;for(let u=0;u<x;u++){const f=Ta(o[u],h[r],d[r],l[i]);!m&&f!==a[i].interpolatorOffsets[u]&&(m=!0),a[i].offset[u]=f}m&&(a[i].interpolate=xa(a[i].offset,ua(o),{clamp:!1}),a[i].interpolatorOffsets=[...a[i].offset]),a[i].progress=ma(0,1,a[i].interpolate(a[i].current))}function Fa(t,a=t,s){if(s.x.targetOffset=0,s.y.targetOffset=0,a!==t){let o=a;for(;o&&o!==t;)s.x.targetOffset+=o.offsetLeft,s.y.targetOffset+=o.offsetTop,o=o.offsetParent}s.x.targetLength=a===t?a.scrollWidth:a.clientWidth,s.y.targetLength=a===t?a.scrollHeight:a.clientHeight,s.x.containerLength=t.clientWidth,s.y.containerLength=t.clientHeight}function Aa(t,a,s,o={}){return{measure:n=>{Fa(t,o.target,s),Ca(t,s,n),(o.offset||o.target)&&Ia(t,s,o)},notify:()=>a(s)}}const V=new WeakMap,nt=new WeakMap,Le=new WeakMap,it=new WeakMap,pe=new WeakMap,rt=t=>t===document.scrollingElement?window:t;function Ot(t,{container:a=document.scrollingElement,trackContentSize:s=!1,...o}={}){if(!a)return Wt;let n=Le.get(a);n||(n=new Set,Le.set(a,n));const i=Na(),r=Aa(a,t,i,o);if(n.add(r),!V.has(a)){const d=()=>{for(const u of n)u.measure(fa.timestamp);ie.preUpdate(h)},h=()=>{for(const u of n)u.notify()},m=()=>ie.read(d);V.set(a,m);const x=rt(a);window.addEventListener("resize",m),a!==document.documentElement&&nt.set(a,ga(a,m)),x.addEventListener("scroll",m),m()}if(s&&!pe.has(a)){const d=V.get(a),h={width:a.scrollWidth,height:a.scrollHeight};it.set(a,h);const m=()=>{const u=a.scrollWidth,f=a.scrollHeight;(h.width!==u||h.height!==f)&&(d(),h.width=u,h.height=f)},x=ie.read(m,!0);pe.set(a,x)}const l=V.get(a);return ie.read(l,!1,!0),()=>{var x;Pe(l);const d=Le.get(a);if(!d||(d.delete(r),d.size))return;const h=V.get(a);V.delete(a),h&&(rt(a).removeEventListener("scroll",h),(x=nt.get(a))==null||x(),window.removeEventListener("resize",h));const m=pe.get(a);m&&(Pe(m),pe.delete(a)),it.delete(a)}}const Wa=[[le.Enter,"entry"],[le.Exit,"exit"],[le.Any,"cover"],[le.All,"contain"]],lt={start:0,end:1};function Pa(t){const a=t.trim().split(/\s+/);if(a.length!==2)return;const s=lt[a[0]],o=lt[a[1]];if(!(s===void 0||o===void 0))return[s,o]}function $a(t){if(t.length!==2)return;const a=[];for(const s of t)if(Array.isArray(s))a.push(s);else if(typeof s=="string"){const o=Pa(s);if(!o)return;a.push(o)}else return;return a}function Ra(t,a){const s=$a(t);if(!s)return!1;for(let o=0;o<2;o++){const n=s[o],i=a[o];if(n[0]!==i[0]||n[1]!==i[1])return!1}return!0}function Be(t){if(!t)return{rangeStart:"contain 0%",rangeEnd:"contain 100%"};for(const[a,s]of Wa)if(Ra(t,a))return{rangeStart:`${s} 0%`,rangeEnd:`${s} 100%`}}const ct=new Map;function dt(t){const a={value:0},s=Ot(o=>{a.value=o[t.axis].progress*100},t);return{currentTime:a,cancel:s}}function Bt({source:t,container:a,...s}){const{axis:o}=s;t&&(a=t);let n=ct.get(a);n||(n=new Map,ct.set(a,n));const i=s.target??"self";let r=n.get(i);r||(r={},n.set(i,r));const l=o+(s.offset??[]).join(",");return r[l]||(s.target&&be(s.target)?Be(s.offset)?r[l]=new ViewTimeline({subject:s.target,axis:o}):r[l]=dt({container:a,...s}):be()?r[l]=new ScrollTimeline({source:a,axis:o}):r[l]=dt({container:a,...s})),r[l]}function Oa(t,a){const s=Bt(a),o=a.target?Be(a.offset):void 0,n=a.target?be(a.target)&&!!o:be();return t.attachTimeline({timeline:n?s:void 0,...o&&n&&{rangeStart:o.rangeStart,rangeEnd:o.rangeEnd},observe:i=>(i.pause(),Rt(r=>{i.time=i.iterationDuration*r},s))})}function Ba(t){return t&&(t.target||t.offset)}function Ha(t){return t.length===2}function Da(t,a){return Ha(t)||Ba(a)?Ot(s=>{t(s[a.axis].progress,s)},a):Rt(t,Bt(a))}function Ht(t,{axis:a="y",container:s=document.scrollingElement,...o}={}){if(!s)return Wt;const n={axis:a,container:s,...o};return typeof t=="function"?Da(t,n):Oa(t,n)}const qa=()=>({scrollX:re(0),scrollY:re(0),scrollXProgress:re(0),scrollYProgress:re(0)}),Q=t=>t?!t.current:!1;function pt(t,a,s,o){return{factory:n=>{let i;const r=()=>{if(Q(s)||Q(o)){$e.read(r);return}i=Ht(n,{...a,axis:t,container:(s==null?void 0:s.current)||void 0,target:(o==null?void 0:o.current)||void 0})};return $e.read(r),()=>{$t(r),i==null||i()}},times:[0,1],keyframes:[0,1],ease:n=>n,duration:1}}function _a(t,a){return typeof window>"u"?!1:t?Ft()&&!!Be(a):At()}function Ga({container:t,target:a,...s}={}){const o=Pt(qa);_a(a,s.offset)&&(o.scrollXProgress.accelerate=pt("x",s,t,a),o.scrollYProgress.accelerate=pt("y",s,t,a));const n=c.useRef(null),i=c.useRef(!1),r=c.useCallback(()=>(n.current=Ht((l,{x:d,y:h})=>{o.scrollX.set(d.current),o.scrollXProgress.set(d.progress),o.scrollY.set(h.current),o.scrollYProgress.set(h.progress)},{...s,container:(t==null?void 0:t.current)||void 0,target:(a==null?void 0:a.current)||void 0}),()=>{var l;(l=n.current)==null||l.call(n)}),[t,a,JSON.stringify(s.offset)]);return ya(()=>{if(i.current=!1,Q(t)||Q(a)){i.current=!0;return}else return r()},[r]),c.useEffect(()=>{if(!i.current)return;let l;const d=()=>{const h=Q(t),m=Q(a);!h&&!m&&(l=r())};return $e.read(d),()=>{$t(d),l==null||l()}},[r]),o}function D(t){const a=Pt(()=>re(t)),{isStatic:s}=c.useContext(ba);if(s){const[,o]=c.useState(t);c.useEffect(()=>a.on("change",o),[])}return a}function _({className:t}){return e.jsxs("div",{className:`relative overflow-hidden rounded-[7px] ${t??"size-6"}`,children:[e.jsx("div",{className:"absolute inset-0 bg-[#1c1c1c]"}),e.jsx("div",{className:"absolute inset-0 bg-[#f84600]",style:{clipPath:"polygon(45% 0%, 100% 0%, 100% 100%, 55% 100%)"}})]})}function we({className:t}){return e.jsx("svg",{viewBox:"0 0 24 24",fill:"none",className:t??"size-5",children:e.jsx("path",{d:"M12 5v14M5 12h14",stroke:"currentColor",strokeWidth:"1.8",strokeLinecap:"round"})})}function ht({className:t}){return e.jsxs("svg",{viewBox:"0 0 24 24",fill:"none",className:t??"size-4",children:[e.jsx("rect",{x:"9",y:"3",width:"6",height:"11",rx:"3",fill:"currentColor"}),e.jsx("path",{d:"M5 11a7 7 0 0 0 14 0M12 18v3",stroke:"currentColor",strokeWidth:"1.8",strokeLinecap:"round"})]})}function R({className:t}){return e.jsx("svg",{viewBox:"0 0 24 24",fill:"none",className:t??"size-4",children:e.jsx("path",{d:"M12 19V6M6 11l6-6 6 6",stroke:"currentColor",strokeWidth:"2",strokeLinecap:"round",strokeLinejoin:"round"})})}function Oe({className:t}){return e.jsx("svg",{viewBox:"0 0 24 24",fill:"none",className:t??"size-3.5",children:e.jsx("path",{d:"M6 9l6 6 6-6",stroke:"currentColor",strokeWidth:"1.8",strokeLinecap:"round",strokeLinejoin:"round"})})}function Ya({className:t}){return e.jsx("svg",{viewBox:"0 0 24 24",fill:"none",className:t??"size-4",children:e.jsx("path",{d:"M6 6l12 12M18 6L6 18",stroke:"currentColor",strokeWidth:"1.8",strokeLinecap:"round"})})}function He({className:t}){return e.jsx("svg",{viewBox:"0 0 24 24",fill:"none",className:t??"size-4",children:e.jsx("path",{d:"M19 12H5M11 18l-6-6 6-6",stroke:"currentColor",strokeWidth:"1.8",strokeLinecap:"round",strokeLinejoin:"round"})})}function Dt({className:t}){return e.jsx("svg",{viewBox:"0 0 24 24",fill:"none",className:t??"size-3.5",children:e.jsx("path",{d:"M9 18l-6-6 6-6M15 6l6 6-6 6",stroke:"currentColor",strokeWidth:"1.8",strokeLinecap:"round",strokeLinejoin:"round"})})}function De({className:t}){return e.jsx("svg",{viewBox:"0 0 24 24",fill:"none",className:t??"size-3.5",children:e.jsx("path",{d:"M12 3l1.8 5.2L19 10l-5.2 1.8L12 17l-1.8-5.2L5 10l5.2-1.8L12 3z",stroke:"currentColor",strokeWidth:"1.5",strokeLinejoin:"round"})})}function qt({className:t}){return e.jsx("svg",{viewBox:"0 0 24 24",fill:"none",className:t??"size-3.5",children:e.jsx("path",{d:"M12 5l9 4.5-9 4.5-9-4.5 9-4.5zM6.5 11.5V16c0 1.4 2.5 3 5.5 3s5.5-1.6 5.5-3v-4.5",stroke:"currentColor",strokeWidth:"1.5",strokeLinejoin:"round"})})}function ke({className:t}){return e.jsx("svg",{viewBox:"0 0 24 24",fill:"none",className:t??"size-4",children:e.jsx("path",{d:"M5 12.5l4.5 4.5L19 7",stroke:"currentColor",strokeWidth:"2",strokeLinecap:"round",strokeLinejoin:"round"})})}function _t({className:t}){return e.jsxs("svg",{viewBox:"0 0 24 24",fill:"none",className:t??"size-4",children:[e.jsx("rect",{x:"5",y:"10.5",width:"14",height:"9.5",rx:"2",stroke:"currentColor",strokeWidth:"1.7"}),e.jsx("path",{d:"M8 10.5V8a4 4 0 0 1 8 0v2.5",stroke:"currentColor",strokeWidth:"1.7",strokeLinecap:"round"})]})}function Gt({className:t}){return e.jsxs("svg",{viewBox:"0 0 24 24",fill:"none",className:t??"size-4",children:[e.jsx("circle",{cx:"11",cy:"11",r:"7",stroke:"currentColor",strokeWidth:"1.8"}),e.jsx("path",{d:"M21 21l-4.3-4.3",stroke:"currentColor",strokeWidth:"1.8",strokeLinecap:"round"})]})}function qe({className:t}){return e.jsx("svg",{viewBox:"0 0 24 24",fill:"none",className:t??"size-3.5",children:e.jsx("path",{d:"M4 16l5.5-5.5 3.5 3.5L20 7M20 7h-4.5M20 7v4.5",stroke:"currentColor",strokeWidth:"1.7",strokeLinecap:"round",strokeLinejoin:"round"})})}function Yt({className:t}){return e.jsx("svg",{viewBox:"0 0 24 24",fill:"none",className:t??"size-3.5",children:e.jsx("path",{d:"M13 3L5 13.5h5.5L11 21l8-10.5h-5.5L13 3z",stroke:"currentColor",strokeWidth:"1.5",strokeLinejoin:"round"})})}function Vt({className:t}){return e.jsx("svg",{viewBox:"0 0 24 24",fill:"none",className:t??"size-3.5",children:e.jsx("path",{d:"M12 3v18M16.5 7.5c0-1.66-2.01-3-4.5-3s-4.5 1.34-4.5 3 2.01 2.5 4.5 3 4.5 1.34 4.5 3-2.01 3-4.5 3-4.5-1.34-4.5-3",stroke:"currentColor",strokeWidth:"1.6",strokeLinecap:"round",strokeLinejoin:"round"})})}function Va({className:t}){return e.jsxs("svg",{viewBox:"0 0 24 24",fill:"none",className:t??"size-3.5",children:[e.jsx("rect",{x:"3",y:"7.5",width:"18",height:"12",rx:"2",stroke:"currentColor",strokeWidth:"1.6"}),e.jsx("path",{d:"M8.5 7.5V6a2 2 0 0 1 2-2h3a2 2 0 0 1 2 2v1.5M3 12.5h18",stroke:"currentColor",strokeWidth:"1.6",strokeLinecap:"round"})]})}function Ua({className:t}){return e.jsx("svg",{viewBox:"0 0 24 24",fill:"none",className:t??"size-3.5",children:e.jsx("path",{d:"M12 3v18M7 21h10M4 7h5M15 7h5M4 7l-2.5 5a2.5 2.5 0 0 0 5 0L4 7zM19 7l-2.5 5a2.5 2.5 0 0 0 5 0L19 7z",stroke:"currentColor",strokeWidth:"1.5",strokeLinecap:"round",strokeLinejoin:"round"})})}function Ut({className:t}){return e.jsx("svg",{viewBox:"0 0 24 24",fill:"none",className:t??"size-3.5",children:e.jsx("path",{d:"M3 6.5a1.5 1.5 0 0 1 1.5-1.5h4l2 2h9a1.5 1.5 0 0 1 1.5 1.5v9a1.5 1.5 0 0 1-1.5 1.5h-15A1.5 1.5 0 0 1 3 17.5v-11z",stroke:"currentColor",strokeWidth:"1.6",strokeLinejoin:"round"})})}function Ka({className:t}){return e.jsxs("svg",{viewBox:"0 0 24 24",fill:"none",className:t??"size-4",children:[e.jsx("circle",{cx:"12",cy:"12",r:"8.5",stroke:"currentColor",strokeWidth:"1.6"}),e.jsx("path",{d:"M12 11v5",stroke:"currentColor",strokeWidth:"1.8",strokeLinecap:"round"}),e.jsx("circle",{cx:"12",cy:"8",r:"1",fill:"currentColor"})]})}const Xa={idle:{scale:[1,1.06,1],opacity:[.75,1,.75],duration:3.4},listening:{scale:[1,1.12,1],opacity:[.85,1,.85],duration:2.2},acknowledging:{scale:[1,.86,1.04,1],opacity:[1,1,1,1],duration:.5},thinking:{scale:[1,1.18,.94,1],opacity:[1,.7,1,1],duration:1.1},settled:{scale:[1,1.03,1],opacity:[.9,1,.9],duration:4.6}};function ce({state:t="idle",depth:a=0,size:s=18}){const o=Xa[t],n=10+a*26,i=.1+a*.22;return e.jsxs("span",{className:"relative inline-flex items-center justify-center",style:{width:s*3,height:s*3},children:[e.jsx(p.span,{"aria-hidden":"true",className:"absolute rounded-full",style:{background:"radial-gradient(circle, rgba(248,70,0,1) 0%, rgba(248,70,0,0) 70%)"},animate:{width:s*(2+a*.9),height:s*(2+a*.9),opacity:i},transition:{duration:.8,ease:[.16,1,.3,1]}}),e.jsx(p.span,{"aria-hidden":"true",className:"relative rounded-full bg-[#f84600]",style:{width:s,height:s,boxShadow:`0 0 ${n}px rgba(248,70,0,.7)`},animate:{scale:o.scale,opacity:o.opacity},transition:{duration:o.duration,repeat:t==="acknowledging"?0:1/0,ease:"easeInOut"}})]})}const xt=.34,ut=.15,U=860,he=560,xe=14;function Za({targetRef:t,image:a}){const s=c.useRef(null),o=c.useRef(null),n=c.useRef(null),i=c.useRef(null);return c.useEffect(()=>{const r=t.current,l=s.current;if(!r||!l||!window.matchMedia("(hover: hover) and (pointer: fine)").matches)return;const h=window.matchMedia("(prefers-reduced-motion: reduce)").matches;let m=0,x=0,u=0,f=0,k=0,w=0,v=!1,E=0;const T=()=>{var $,j,N,y;($=i.current)==null||$.style.setProperty("transform",`translate3d(${u-xe/2}px, ${f-xe/2}px, 0)`),(j=n.current)==null||j.style.setProperty("transform",`translate3d(${k-he/2}px, ${w-he/2}px, 0)`),(N=o.current)==null||N.style.setProperty("--mx",`${k-U/2}px`),(y=o.current)==null||y.style.setProperty("--my",`${w-U/2}px`)},F=()=>{u+=(m-u)*xt,f+=(x-f)*xt,k+=(u-k)*ut,w+=(f-w)*ut,T(),E=requestAnimationFrame(F)},z=$=>{const j=r.getBoundingClientRect();if(m=$.clientX-j.left,x=$.clientY-j.top,!v){if(v=!0,u=k=m,f=w=x,T(),h)return;E=requestAnimationFrame(F)}h&&(u=k=m,f=w=x,T())},A=()=>l.classList.add("hs-on"),M=()=>{l.classList.remove("hs-on"),cancelAnimationFrame(E),E=0,v=!1};return r.addEventListener("pointermove",z),r.addEventListener("pointerenter",A),r.addEventListener("pointerleave",M),r.classList.add("hs-host"),()=>{r.removeEventListener("pointermove",z),r.removeEventListener("pointerenter",A),r.removeEventListener("pointerleave",M),r.classList.remove("hs-host"),cancelAnimationFrame(E)}},[t]),e.jsxs("div",{ref:s,className:"hs-root","aria-hidden":"true",children:[e.jsxs("div",{className:"hs-light-layer",children:[e.jsx("div",{ref:o,className:"hs-lit"}),e.jsx("div",{ref:n,className:"hs-glow"})]}),e.jsx("div",{className:"hs-cursor-layer",children:e.jsx("div",{ref:i,className:"hs-dot"})}),e.jsx("style",{children:`
...
def parse_config(path):
    ...
    `})]})}function is({onEnterGuest:t,onStartTask:a}){const[s,o]=c.useState(""),n=()=>t(s.trim()||void 0);return e.jsxs("div",{children:[e.jsxs(p.div,{initial:{opacity:0,y:10},animate:{opacity:1,y:0},transition:{duration:.45},className:"mb-5 flex items-center gap-2",children:[e.jsx(ce,{state:"idle",size:10}),e.jsx("span",{className:"text-[12px] font-medium tracking-[0.16em] text-[#ffa940] uppercase",style:{fontFamily:"var(--font-google-sans)"},children:"An AI that gets to know you"})]}),e.jsx(p.h1,{initial:{opacity:0,y:12},animate:{opacity:1,y:0},transition:{duration:.6,ease:[.16,1,.3,1]},className:"max-w-[640px] text-[42px] leading-[1.08] font-semibold text-white sm:text-[56px]",style:{fontFamily:"var(--font-google-sans)"},children:"Starchild understands your context — and helps you get things done."}),e.jsx(p.p,{initial:{opacity:0,y:12},animate:{opacity:1,y:0},transition:{duration:.55,delay:.08},className:"mt-5 max-w-[520px] text-[17px] leading-relaxed text-white/72",style:{fontFamily:"var(--font-google-sans)"},children:"You don't need the perfect question. Start anywhere — no account needed."}),e.jsxs(p.div,{initial:{opacity:0,y:16},animate:{opacity:1,y:0},transition:{duration:.55,delay:.15},className:"mt-8 max-w-[600px] rounded-[22px] border border-white/12 bg-white/[0.06] p-4 backdrop-blur-sm transition-colors focus-within:border-white/30",children:[e.jsx("input",{value:s,onChange:i=>o(i.target.value),onKeyDown:i=>{i.key==="Enter"&&n()},placeholder:"What's on your mind?",className:"w-full bg-transparent text-[16px] text-white placeholder:text-white/35 focus:outline-none",style:{fontFamily:"var(--font-google-sans)"}}),e.jsx("div",{className:"mt-4 flex items-center justify-end",children:e.jsxs("button",{type:"button",onClick:n,className:"flex items-center gap-2 rounded-full bg-[#f84600] px-5 py-2.5 text-[13.5px] font-medium text-white shadow-[0_8px_24px_rgba(248,70,0,.32)] transition-transform hover:scale-[1.03]",style:{fontFamily:"var(--font-google-sans)"},children:["Meet Starchild",e.jsx(R,{className:"size-3.5 rotate-90"})]})})]}),e.jsx(p.div,{initial:{opacity:0},animate:{opacity:1},transition:{duration:.55,delay:.28},className:"mt-6",children:e.jsx(_e,{onStartTask:a})})]})}const rs="./images/empresas.svg",ls=6;function ta(){return e.jsxs("section",{className:"uw-section bg-[#0a0a0a] py-20 md:py-24",children:[e.jsx(L,{children:e.jsx("div",{className:"grid grid-cols-12 gap-6",children:e.jsx("p",{className:"col-span-12 text-center text-[13px] tracking-[0.16em] text-white/40 uppercase",style:{fontFamily:"var(--font-google-sans)"},children:"Trusted by people at"})})}),e.jsx("div",{className:"uw-viewport mt-10","aria-hidden":"true",children:e.jsx("div",{className:"uw-track",children:Array.from({length:ls},(t,a)=>e.jsx("img",{src:rs,alt:"",className:"uw-strip"},a))})}),e.jsx("style",{children:`
      ...
      `})]})}const ft="(min-width: 1024px) and (min-height: 560px)",yt="(prefers-reduced-motion: reduce)";function aa(){const t=()=>typeof window<"u"&&window.matchMedia(ft).matches&&!window.matchMedia(yt).matches,[a,s]=c.useState(t);return c.useEffect(()=>{const o=window.matchMedia(ft),n=window.matchMedia(yt),i=()=>s(o.matches&&!n.matches);return i(),o.addEventListener("change",i),n.addEventListener("change",i),()=>{o.removeEventListener("change",i),n.removeEventListener("change",i)}},[]),a}function sa(t,a,s){const o=c.useRef(s);o.current=s,c.useEffect(()=>{if(!a)return;const n=()=>{const i=t.current;if(!i)return;const r=i.offsetHeight-window.innerHeight;if(r<=0)return;const l=-i.getBoundingClientRect().top/r;o.current(l<0?0:l>1?1:l)};return n(),window.addEventListener("scroll",n,{passive:!0}),window.addEventListener("resize",n),()=>{window.removeEventListener("scroll",n),window.removeEventListener("resize",n)}},[a,t])}function Ge(t){const a=c.useRef(null),s=aa(),[o,n]=c.useState(0);return sa(a,s,r=>{n(Math.max(0,Math.min(t-1,Math.floor(r*t))))}),{trackRef:a,pinned:s,index:o,selectStep:r=>{const l=a.current;if(!s||!l){n(r);return}const d=l.getBoundingClientRect().top+window.scrollY,h=l.offsetHeight-window.innerHeight;window.scrollTo({top:d+h*((r+.5)/t),behavior:"smooth"})}}}function Ne({trackRef:t,pinned:a,screens:s,children:o}){const n=c.useRef(null),[i,r]=c.useState(1);return c.useLayoutEffect(()=>{if(!a){r(1);return}const l=n.current;if(!l)return;const d=()=>{const m=l.offsetHeight,x=window.innerHeight-32;r(m>x?Math.max(.62,x/m):1)};d();const h=new ResizeObserver(d);return h.observe(l),window.addEventListener("resize",d),()=>{h.disconnect(),window.removeEventListener("resize",d)}},[a]),e.jsxs("div",{ref:t,className:`sp-track${a?" sp-track--pinned":""}`,style:{"--sp-screens":String(s)},children:[e.jsx("div",{className:"sp-pane",children:e.jsx("div",{ref:n,className:"sp-fit",style:i===1?void 0:{transform:`scale(${i})`},children:o})}),e.jsx("style",{children:`
      ...
      `})]})}function cs({useCase:t}){return e.jsxs("div",{className:"pw-frame",children:[e.jsxs("div",{className:"pw-chrome",children:[e.jsx(_,{className:"size-[15px]"}),e.jsx("span",{className:"pw-chrome-title",children:"Conductor Mode"})]}),e.jsxs("div",{className:"pw-body",children:[e.jsx("div",{className:"pw-prompt-row",children:e.jsx("p",{className:"pw-prompt",children:t.prompt})}),e.jsx("ol",{className:"pw-steps",children:t.steps.map((a,s)=>e.jsxs(p.li,{initial:{opacity:0,x:-6},animate:{opacity:1,x:0},transition:{duration:.35,delay:.1+s*.09,ease:[.16,1,.3,1]},className:`pw-step${s===t.steps.length-1?" pw-step--done":""}`,children:[e.jsx("span",{className:"pw-dot","aria-hidden":"true"}),a]},a))}),e.jsx(p.div,{initial:{opacity:0,y:8},animate:{opacity:1,y:0},transition:{duration:.4,delay:.38,ease:[.16,1,.3,1]},children:e.jsx(ds,{result:t.result})},t.id)]}),e.jsx("style",{children:`
        .pw-frame {
      ...
      `})]})}const xs=[{file:"OpenAI.svg",w:148,h:40},{file:"Claude.svg",w:160,h:34},{file:"Frame374.svg",w:151,h:34},{file:"Frame375.svg",w:137,h:40},{file:"Deepseek.svg",w:206,h:33},{file:"Kimi.svg",w:118,h:40}],bt=16,us=[{title:"No model-hopping",desc:"Stop guessing which AI to use."},{title:"Better context",desc:"The model gets the information it actually needs."},{title:"Less waste",desc:"Starchild can avoid sending unnecessary context to expensive models."},{title:"Always adapting",desc:"As models change, you don't have to rebuild your workflow around them."}],wt=.06,ms=.46,vt=.56,gs=.92,jt=t=>t<0?0:t>1?1:t,K=(t,a,s)=>t+(a-t)*s,kt=t=>t<.5?2*t*t:1-(-2*t+2)**2/2;function me(t,a,s){const o=t.getBoundingClientRect();return{left:(o.left-a.left)/s,top:(o.top-a.top)/s,width:o.width/s,height:o.height/s}}function Nt(t,a){return{x:Math.max(t.left,Math.min(a.x,t.left+t.width)),y:Math.max(t.top,Math.min(a.y,t.top+t.height))}}function St({label:t,innerRef:a,children:s}){return e.jsxs("div",{className:"ky-panel",ref:a,children:[e.jsx("p",{className:"ky-panel-label",children:t}),s]})}function Ye(){const t=c.useRef(null),a=c.useRef(null),s=c.useRef(null),o=c.useRef(null),n=c.useRef(null),i=c.useRef(null),r=c.useRef(null),l=D(0),d=D(0),h=D(0),m=D(0),x=D(0),u=D(0),f=D(0),k=D(0),w=D(0),[v,E]=c.useState(!1),[T,F]=c.useState(!1),[z,A]=c.useState(!1),M=aa(),{scrollYProgress:$}=Ga({target:a,offset:["start 0.85","end 0.55"]});c.useEffect(()=>{const y=window.matchMedia("(prefers-reduced-motion: reduce)"),S=()=>A(y.matches);S(),y.addEventListener("change",S);const g=()=>{const I=a.current,b=s.current,B=o.current,G=n.current,se=i.current;if(!I||!b||!B||!G||!se)return;const W=I.getBoundingClientRect(),P=I.offsetWidth?W.width/I.offsetWidth:1,C=me(G,W,P),H={x:C.left+C.width/2,y:C.top+C.height/2},O=me(se,W,P);r.current={conductor:H,you:Nt(me(b,W,P),H),models:Nt(me(B,W,P),H),result:{x:O.left+O.width/2,y:O.top}}};return g(),window.addEventListener("resize",g),()=>{window.removeEventListener("resize",g),y.removeEventListener("change",S)}},[]),c.useEffect(()=>{window.dispatchEvent(new Event("resize"))},[M]);const j=y=>{const S=r.current;if(!S)return;const g=kt(jt((y-wt)/(ms-wt))),I=kt(jt((y-vt)/(gs-vt)));l.set(K(S.you.x,S.conductor.x,g)),d.set(K(S.you.y,S.conductor.y,g)),m.set(K(S.models.x,S.conductor.x,g)),x.set(K(S.models.y,S.conductor.y,g));const b=g<=0?0:g>.94?(1-g)/.06:Math.min(1,g/.08);h.set(b),u.set(b),f.set(K(S.conductor.x,S.result.x,I)),k.set(K(S.conductor.y,S.result.y,I)),w.set(I<=0?0:I>.93?(1-I)/.07:Math.min(1,I/.08)),E(g>.9),F(I>.88)};sa(t,M,j),ja($,"change",y=>{M||j(y)});const N=z||T;return e.jsxs("section",{className:"ky-section bg-[#0a0a0a] py-24 md:py-32",children:[e.jsx(Ne,{trackRef:t,pinned:M,screens:2,children:e.jsxs(L,{children:[e.jsx("div",{className:"grid grid-cols-12 gap-6",children:e.jsxs("div",{className:"col-span-12 mx-auto max-w-[52ch] text-center",children:[e.jsx(p.h2,{initial:{opacity:0,y:14},whileInView:{opacity:1,y:0},viewport:{once:!0,amount:.5},transition:{duration:.55,ease:[.16,1,.3,1]},className:"text-[34px] leading-[1.1] font-semibold text-balance text-white sm:text-[44px]",style:{fontFamily:"var(--font-google-sans)"},children:"It knows you. It knows AI."}),e.jsx("p",{className:"mt-5 text-[16px] leading-relaxed text-white/60",style:{fontFamily:"var(--font-google-sans)"},children:"Starchild learns how you work and chooses the right AI for each task."})]})}),e.jsx("div",{className:"mt-16 grid grid-cols-12 gap-6",children:e.jsx("div",{className:"col-span-12",children:e.jsxs("div",{className:"ky-stage",ref:a,children:[e.jsxs("div",{className:"ky-flow",children:[e.jsx(St,{label:"You",innerRef:s,children:e.jsx("ul",{className:"ky-list",children:es.map(y=>e.jsx("li",{children:y},y))})}),e.jsxs("div",{className:`ky-conductor${v?" ky-conductor--hit":""}`,ref:n,children:[e.jsx(ce,{state:v?"thinking":"idle",depth:v?1:.35,size:16}),e.jsx("p",{className:"ky-conductor-label",children:"Conductor"})]}),e.jsx(St,{label:"Available models",innerRef:o,children:e.jsx("div",{className:"ky-logos",children:xs.map(y=>e.jsx("img",{src:`./images/carousel/${y.file}`,alt:"",style:{height:bt,width:bt*(y.w/y.h)}},y.file))})})]}),e.jsxs("div",{className:`ky-result${N?" ky-result--lit":""}`,ref:i,children:[e.jsx("p",{className:"ky-result-label",children:"Result"}),e.jsx("p",{className:"ky-result-text",children:"One answer, routed to the right model."})]}),!z&&e.jsxs("div",{className:"ky-dots","aria-hidden":"true",children:[e.jsx(p.span,{className:"ky-dot",style:{x:l,y:d,opacity:h}}),e.jsx(p.span,{className:"ky-dot",style:{x:m,y:x,opacity:u}}),e.jsx(p.span,{className:"ky-dot ky-dot--result",style:{x:f,y:k,opacity:w}})]})]})})})]})}),e.jsx(L,{children:e.jsx("div",{className:"mt-20 grid grid-cols-12 gap-6",children:us.map((y,S)=>e.jsx(p.div,{initial:{opacity:0,y:14},whileInView:{opacity:1,y:0},viewport:{once:!0,amount:.4},transition:{duration:.5,delay:S*.06,ease:[.16,1,.3,1]},className:"col-span-12 sm:col-span-6 lg:col-span-3",children:e.jsxs("div",{className:"ky-benefit",children:[e.jsx("h3",{className:"ky-benefit-title",children:y.title}),e.jsx("p",{className:"ky-benefit-desc",children:y.desc})]})},y.title))})}),e.jsx("style",{children:`
      ...
      `})]})}function Ts({onEnterGuest:t,onStartTask:a,onNavigateConductorMode:s,onOpenMarketplace:o,onLogIn:n,onSignUp:i}){const r=c.useRef(null),l=()=>t();return e.jsxs("div",{children:[e.jsx(ea,{onEnterGuest:t,onStartTask:a,onNavigateConductorMode:s,onOpenMarketplace:o,onLogIn:n,onSignUp:i}),e.jsx(ta,{}),e.jsx(Ss,{onStartTask:a}),e.jsx(Ls,{onStartTask:a}),e.jsx("div",{ref:r,children:e.jsx(Ye,{})}),e.jsx(Se,{onStartFree:l})]})}const Ms=[{id:"traders",label:"For Traders",route:"traders"},{id:"developers",label:"For Developers"},{id:"creators",label:"For Creators"},{id:"researchers",label:"For Researchers"}];function oa({onNavigateHome:t,onNavigateTraders:a,onLogIn:s,onSignUp:o}){const[n,i]=c.useState(!1),r=c.useRef(null);return c.useEffect(()=>{if(!n)return;const l=h=>{var m;(m=r.current)!=null&&m.contains(h.target)||i(!1)},d=h=>{h.key==="Escape"&&i(!1)};return document.addEventListener("pointerdown",l),document.addEventListener("keydown",d),()=>{document.removeEventListener("pointerdown",l),document.removeEventListener("keydown",d)}},[n]),e.jsxs("header",{className:"relative z-20 py-6",children:[e.jsx(L,{children:e.jsxs("div",{className:"grid grid-cols-[1fr_auto_1fr] items-center gap-4",children:[e.jsx("div",{className:"flex items-center",children:e.jsxs("button",{type:"button",onClick:t,className:"flex items-center gap-2.5",children:[e.jsx(_,{className:"size-7"}),e.jsx("span",{className:"text-[15px] font-semibold tracking-[0.16em] text-white",style:{fontFamily:"var(--font-google-sans)"},children:"STARCHILD"})]})}),e.jsxs("nav",{className:"sh-nav","aria-label":"Main",children:[e.jsxs("div",{className:"sh-menu",ref:r,children:[e.jsxs("button",{type:"button",onClick:()=>i(l=>!l),"aria-expanded":n,"aria-haspopup":"true",className:`sh-trigger${n?" sh-trigger--open":""}`,children:["Starchild for",e.jsx(Oe,{className:"sh-chevron size-3.5"})]}),n&&e.jsx("div",{className:"sh-panel",role:"menu",children:Ms.map(({id:l,label:d,route:h})=>e.jsx("button",{type:"button",role:"menuitem",onClick:()=>{i(!1),h==="traders"&&a()},className:"sh-item",children:d},l))})]}),e.jsx("button",{type:"button",onClick:()=>{},className:"sh-trigger",children:"Pricing"}),e.jsxs("button",{type:"button",onClick:()=>{},className:"sh-trigger sh-trigger--badged",children:["Marketplace",e.jsx("span",{className:"sh-badge",children:"New"})]})]}),e.jsxs("div",{className:"flex items-center justify-end gap-2 sm:gap-4",children:[e.jsx("button",{type:"button",onClick:s,className:"px-1 text-[13.5px] font-medium text-white/70 transition-colors hover:text-white",style:{fontFamily:"var(--font-google-sans)"},children:"Log in"}),e.jsx("button",{type:"button",onClick:o,className:"rounded-full border border-white/20 bg-white/10 px-5 py-2.5 text-[13.5px] font-medium text-white backdrop-blur-sm transition-colors hover:bg-white/20",style:{fontFamily:"var(--font-google-sans)"},children:"Sign up"})]})]})}),e.jsx("style",{children:`
      ...
      `})]})}const X=22,Es=3.1,Ee=280,Is=14,Ct=3.4,je=22,Z=[122,138,154],Ie=[255,140,44],zt=.34,Lt=.15,Fs=.08,As=14;function Ws(){return Array.from({length:je},(t,a)=>{const s=a/(je-1),o=Math.round(Z[0]+(Ie[0]-Z[0])*s),n=Math.round(Z[1]+(Ie[1]-Z[1])*s),i=Math.round(Z[2]+(Ie[2]-Z[2])*s),r=.09+.78*Math.pow(s,1.25);return{color:`rgba(${o},${n},${i},${r.toFixed(3)})`,size:Es+2.6*s,points:[]}})}function Ps({targetRef:t}){const a=c.useRef(null);return c.useEffect(()=>{const s=t.current,o=a.current,n=o==null?void 0:o.getContext("2d");if(!s||!o||!n)return;const i=window.matchMedia("(prefers-reduced-motion: reduce)").matches,r=window.matchMedia("(hover: hover) and (pointer: fine)").matches,l=Ws();r&&s.classList.add("hero-c--fine");let d=0,h=0,m=0,x=0,u=-9999,f=-9999,k=-9999,w=-9999,v=-9999,E=-9999,T=0,F=0,z=!1,A=0,M=!1;const $=performance.now(),j=W=>{const P=(W-$)/1e3;if(n.clearRect(0,0,d,h),T>.01){const C=n.createRadialGradient(v,E,0,v,E,Ee*1.5);C.addColorStop(0,`rgba(248,70,0,${(.13*T).toFixed(3)})`),C.addColorStop(.45,`rgba(248,70,0,${(.05*T).toFixed(3)})`),C.addColorStop(1,"rgba(248,70,0,0)"),n.fillStyle=C,n.fillRect(0,0,d,h)}for(const C of l)C.points.length=0;for(let C=0;C<x;C++)for(let H=0;H<m;H++){const O=H*X-X,de=C*X-X;let Ce=O+Math.sin(O*.021+de*.013+P*.55)*Ct,ze=de+Math.cos(O*.017-de*.019+P*.42)*Ct,Xe=.16+.14*(.5+.5*Math.sin(O*.011+de*.009-P*.7));if(T>.01){const Ze=Ce-v,Qe=ze-E,oe=Math.hypot(Ze,Qe);if(oe<Ee){const Je=1-oe/Ee,et=Je*Je*T;if(Xe+=et*1.15,oe>.001){const tt=et*Is;Ce+=Ze/oe*tt,ze+=Qe/oe*tt}}}const ca=Math.min(je-1,Math.max(0,Math.round(Xe*(je-1))));l[ca].points.push(Ce,ze)}for(const C of l){if(C.points.length===0)continue;n.fillStyle=C.color;const H=C.size/2;for(let O=0;O<C.points.length;O+=2)n.fillRect(C.points[O]-H,C.points[O+1]-H,C.size,C.size)}if(r&&T>.01){const C=i?1:1+.16*(.5-.5*Math.cos(P/3.6*Math.PI*2)),H=As/2*C;n.save(),n.globalAlpha=T,n.shadowColor="rgba(248,70,0,.9)",n.shadowBlur=18,n.fillStyle="#f84600",n.beginPath(),n.arc(k,w,H,0,Math.PI*2),n.fill(),n.restore()}},N=()=>{const W=s.getBoundingClientRect(),P=Math.min(window.devicePixelRatio||1,2);d=Math.max(1,Math.round(W.width)),h=Math.max(1,Math.round(W.height)),o.width=Math.round(d*P),o.height=Math.round(h*P),o.style.width=`${d}px`,o.style.height=`${h}px`,n.setTransform(P,0,0,P,0,0),m=Math.ceil(d/X)+2,x=Math.ceil(h/X)+2,j(performance.now())},y=W=>{k+=(u-k)*zt,w+=(f-w)*zt,v+=(k-v)*Lt,E+=(w-E)*Lt,T+=(F-T)*Fs,j(W),A=requestAnimationFrame(y)},S=()=>{M||i||(M=!0,A=requestAnimationFrame(y))},g=()=>{M=!1,cancelAnimationFrame(A)},I=W=>{const P=s.getBoundingClientRect();u=W.clientX-P.left,f=W.clientY-P.top,z||(z=!0,k=v=u,w=E=f),F=1,i&&(k=v=u,w=E=f,T=1,j(performance.now()))},b=()=>{F=0,z=!1,i&&(T=0,j(performance.now()))},B=new IntersectionObserver(([W])=>W.isIntersecting?S():g(),{threshold:0});B.observe(s);const G=()=>document.hidden?g():S(),se=new ResizeObserver(N);return se.observe(s),s.addEventListener("pointermove",I),s.addEventListener("pointerleave",b),document.addEventListener("visibilitychange",G),N(),()=>{B.disconnect(),se.disconnect(),s.removeEventListener("pointermove",I),s.removeEventListener("pointerleave",b),document.removeEventListener("visibilitychange",G),s.classList.remove("hero-c--fine"),g()}},[t]),e.jsx("canvas",{ref:a,className:"absolute inset-0 z-0 h-full w-full","aria-hidden":"true"})}const na=[{id:"talk",label:"Talk",icon:De,tasks:[{id:"talk-through",label:"Talk something through",basePrompt:"I want to talk something through — help me think out loud about it.",question:"What's on your mind?"},{id:"talk-decision",label:"Help me decide",basePrompt:"Help me think through this decision and show me what I might be missing.",question:"What are you weighing up?"}]},{id:"research",label:"Research",icon:qt,tasks:[{id:"research-topic",label:"Look into something",basePrompt:"Look into this properly and come back with a real answer, not a pile of links.",question:"What should I dig into?"},{id:"research-compare",label:"Compare my options",basePrompt:"Compare these options properly and show me where they genuinely differ.",question:"What should I put side by side?"}]},{id:"build",label:"Build",icon:Dt,tasks:[{id:"build-idea",label:"Turn an idea into something real",basePrompt:"Turn this idea into something real I can actually use.",question:"Tell me the idea — a sentence is enough."},{id:"build-dashboard",label:"Create a dashboard",basePrompt:"Build a dashboard that tracks what matters and keeps itself up to date.",question:"What should the dashboard track?"}]},{id:"work",label:"Work",icon:Va,tasks:[{id:"work-priorities",label:"Sort out my week",basePrompt:"Help me work out what actually matters right now and what can wait.",question:"What's on your plate at the moment?"},{id:"work-draft",label:"Draft something I owe someone",basePrompt:"Help me write the thing I've been putting off sending.",question:"Who's it for, and what does it need to say?"}]},{id:"organize",label:"Organize",icon:Ut,tasks:[{id:"organize-work",label:"Get on top of things",basePrompt:"Help me bring some structure to everything I've got going on.",question:"What do you need to get on top of?"},{id:"organize-project",label:"Bring order to a project",basePrompt:"Take this project and give it a structure I can actually follow.",question:"What's the project?"}]}];function $s({onEnterGuest:t,onStartTask:a,onNavigateTraders:s,onLogIn:o,onSignUp:n}){const i=c.useRef(null);return e.jsxs("section",{ref:i,className:"hero-c relative flex min-h-screen flex-col overflow-hidden",children:[e.jsx(Ps,{targetRef:i}),e.jsx("div",{className:"hero-c-vignette","aria-hidden":"true"}),e.jsx(oa,{onNavigateHome:()=>{},onNavigateTraders:s,onLogIn:o,onSignUp:n}),e.jsx("main",{className:"relative z-10 flex flex-1 items-center pb-20",children:e.jsx(L,{className:"w-full",children:e.jsx("div",{className:"grid grid-cols-12 gap-6",children:e.jsx("div",{className:"col-span-12 lg:col-span-7",children:e.jsx(Rs,{onEnterGuest:t,onStartTask:a})})})})}),e.jsx("style",{children:`
    ...
    `})]})}function Rs({onEnterGuest:t,onStartTask:a}){const[s,o]=c.useState(""),n=()=>t(s.trim()||void 0);return e.jsxs("div",{children:[e.jsx(p.h1,{initial:{opacity:0,y:12},animate:{opacity:1,y:0},transition:{duration:.6,ease:[.16,1,.3,1]},className:"max-w-[640px] text-[42px] leading-[1.08] font-semibold text-balance text-white sm:text-[56px]",style:{fontFamily:"var(--font-google-sans)"},children:"One AI for everything that matters to you."}),e.jsxs(p.div,{initial:{opacity:0,y:16},animate:{opacity:1,y:0},transition:{duration:.55,delay:.15},className:"mt-10 max-w-[600px] rounded-[22px] border border-white/12 bg-white/[0.06] p-4 backdrop-blur-sm transition-colors focus-within:border-white/30",children:[e.jsx("input",{value:s,onChange:i=>o(i.target.value),onKeyDown:i=>{i.key==="Enter"&&n()},placeholder:"What's on your mind?",className:"w-full bg-transparent text-[16px] text-white placeholder:text-white/35 focus:outline-none",style:{fontFamily:"var(--font-google-sans)"}}),e.jsx("div",{className:"mt-4 flex items-center justify-end",children:e.jsxs("button",{type:"button",onClick:n,className:"flex items-center gap-2 rounded-full bg-[#f84600] px-5 py-2.5 text-[13.5px] font-medium text-white shadow-[0_8px_24px_rgba(248,70,0,.32)] transition-transform hover:scale-[1.03]",style:{fontFamily:"var(--font-google-sans)"},children:["Meet Starchild",e.jsx(R,{className:"size-3.5 rotate-90"})]})})]}),e.jsx(p.div,{initial:{opacity:0},animate:{opacity:1},transition:{duration:.55,delay:.28},className:"mt-6",children:e.jsx(_e,{onStartTask:a,intents:na})})]})}const ae="0 0 160 96",J="rgba(255,255,255,.26)",ee="rgba(255,255,255,.12)";function Os({className:t=""}){const a=[{y:22,w:62},{y:32,w:44}],s=[{y:56,w:66},{y:66,w:50},{y:76,w:34}];return e.jsxs("svg",{viewBox:ae,className:`cg-svg cg-svg--talk ${t}`,fill:"none","aria-hidden":"true",children:[a.map((o,n)=>e.jsx("line",{className:"cg-say",style:{"--i":n,transformOrigin:"left center"},x1:"14",y1:o.y,x2:14+o.w,y2:o.y,stroke:J,strokeWidth:"1"},o.y)),s.map((o,n)=>e.jsx("line",{className:"cg-say cg-say--reply",style:{"--i":n+2,transformOrigin:"right center"},x1:146-o.w,y1:o.y,x2:"146",y2:o.y,stroke:n===0?"var(--color-primary)":J,strokeWidth:n===0?1.6:1},o.y)),e.jsx("circle",{cx:"8",cy:"22",r:"2",fill:"rgba(255,255,255,.4)"}),e.jsx("circle",{cx:"152",cy:"56",r:"2.4",fill:"var(--color-primary)"})]})}function Bs({className:t=""}){const a=[{x:26,ys:[26,48,70]},{x:80,ys:[20,48,76]},{x:134,ys:[32,62]}];return e.jsxs("svg",{viewBox:ae,className:`cg-svg cg-svg--think ${t}`,fill:"none","aria-hidden":"true",children:[a[0].ys.map(o=>a[1].ys.map(n=>e.jsx("line",{x1:"26",y1:o,x2:"80",y2:n,stroke:ee,strokeWidth:"1"},`${o}-${n}`))),a[1].ys.map(o=>a[2].ys.map(n=>e.jsx("line",{x1:"80",y1:o,x2:"134",y2:n,stroke:ee,strokeWidth:"1"},`b${o}-${n}`))),e.jsx("path",{className:"cg-route",d:"M26 48 L80 20 L134 32",stroke:"var(--color-primary)",strokeWidth:"1.6",strokeLinecap:"round",strokeLinejoin:"round"}),a.map(({x:o,ys:n})=>n.map(i=>e.jsx("circle",{cx:o,cy:i,r:"2.2",fill:"rgba(255,255,255,.34)"},`${o}-${i}`))),e.jsx("circle",{cx:"134",cy:"32",r:"3",fill:"var(--color-primary)"})]})}function Hs({className:t=""}){const a=[{y:22,x:26,w:58},{y:34,x:12,w:84},{y:46,x:34,w:46},{y:58,x:20,w:72},{y:70,x:44,w:38}];return e.jsxs("svg",{viewBox:ae,className:`cg-svg cg-svg--work ${t}`,fill:"none","aria-hidden":"true",children:[e.jsx("line",{x1:"8",y1:"14",x2:"8",y2:"82",stroke:ee,strokeWidth:"1"}),a.map((s,o)=>e.jsx("line",{className:"cg-row",style:{"--dx":`${s.x-12}px`,"--i":o},x1:"12",y1:s.y,x2:12+s.w,y2:s.y,stroke:o===0?"var(--color-primary)":J,strokeWidth:o===0?1.6:1},s.y))]})}function Ds({className:t=""}){const a=[16,30,44,58,72];return e.jsxs("svg",{viewBox:ae,className:`cg-svg cg-svg--explore ${t}`,fill:"none","aria-hidden":"true",children:[a.map((s,o)=>e.jsx("path",{className:"cg-feed",style:{"--i":o},d:`M8 ${s} C 52 ${s}, 62 48, 96 48`,stroke:J,strokeWidth:"1"},s)),e.jsx("line",{x1:"96",y1:"48",x2:"150",y2:"48",stroke:"var(--color-primary)",strokeWidth:"1.4"}),e.jsx("circle",{className:"cg-node",cx:"96",cy:"48",r:"4",fill:"none",stroke:"var(--color-primary)",strokeWidth:"1.4"}),e.jsx("circle",{cx:"96",cy:"48",r:"1.6",fill:"var(--color-primary)"})]})}function qs({className:t=""}){return e.jsxs("svg",{viewBox:ae,className:`cg-svg cg-svg--create ${t}`,fill:"none","aria-hidden":"true",children:[e.jsx("line",{x1:"14",y1:"80",x2:"146",y2:"80",stroke:ee,strokeWidth:"1"}),e.jsx("path",{d:"M52 62 L80 74 L108 62 L80 50 Z",stroke:J,strokeWidth:"1"}),e.jsxs("g",{className:"cg-rise",children:[e.jsx("path",{d:"M52 62 L52 38 M108 62 L108 38 M80 74 L80 50",stroke:ee,strokeWidth:"1"}),e.jsx("path",{d:"M52 38 L80 50 L108 38 L80 26 Z",stroke:"var(--color-primary)",strokeWidth:"1.3"})]}),e.jsx("circle",{cx:"80",cy:"26",r:"2.2",fill:"var(--color-primary)"})]})}function _s({className:t=""}){const a=[{x:18,y:20,w:34,h:12,dx:9,dy:-6},{x:18,y:38,w:34,h:12,dx:-7,dy:5},{x:18,y:56,w:34,h:12,dx:6,dy:8},{x:63,y:20,w:34,h:12,dx:-8,dy:7},{x:63,y:38,w:34,h:12,dx:7,dy:-8},{x:108,y:20,w:34,h:12,dx:8,dy:9}];return e.jsxs("svg",{viewBox:ae,className:`cg-svg cg-svg--organize ${t}`,fill:"none","aria-hidden":"true",children:[[35,80,125].map(s=>e.jsx("line",{x1:s,y1:"14",x2:s,y2:"82",stroke:ee,strokeWidth:"1"},s)),a.map((s,o)=>e.jsx("rect",{className:"cg-block",style:{"--dx":`${s.dx}px`,"--dy":`${s.dy}px`,"--i":o},x:s.x,y:s.y,width:s.w,height:s.h,rx:"3",stroke:o===0?"var(--color-primary)":J,strokeWidth:o===0?1.4:1},`${s.x}-${s.y}`))]})}const Gs=[{id:"talk",tag:"Conversation",title:"Talk",copy:"Talk things through with an AI that gets to know you.",art:Os,task:{id:"talk-through",label:"Talk something through",basePrompt:"I want to talk something through — help me think out loud about it.",question:"What's on your mind?"}},{id:"think",tag:"Decisions",title:"Think",copy:"Work through ideas, questions, and decisions together.",art:Bs,task:{id:"think-decision",label:"Think through a decision",basePrompt:"Help me think through this decision and show me what I might be missing.",question:"What are you weighing up?"}},{id:"work",tag:"Day to day",title:"Work",copy:"Get through what's on your plate.",art:Hs,task:{id:"work-priorities",label:"Sort out my week",basePrompt:"Help me work out what actually matters right now and what can wait.",question:"What's on your plate at the moment?"}},{id:"explore",tag:"Curiosity",title:"Explore",copy:"Learn, compare, and make sense of things.",art:Ds,task:{id:"explore-topic",label:"Make sense of something",basePrompt:"Help me understand this properly — what matters, what doesn't, and why.",question:"What do you want to get to the bottom of?"}},{id:"create",tag:"Make",title:"Create",copy:"Turn an idea into something real.",art:qs,task:{id:"create-idea",label:"Turn an idea into something real",basePrompt:"Turn this idea into something real I can actually use.",question:"Tell me the idea — a sentence is enough."}},{id:"organize",tag:"Structure",title:"Organize",copy:"Bring structure to tasks, projects, and recurring work.",art:_s,task:{id:"organize-work",label:"Get on top of things",basePrompt:"Help me bring some structure to everything I've got going on.",question:"What do you need to get on top of?"}}];function Ys({onStartTask:t}){return e.jsxs("section",{className:"cg-section bg-[#0a0a0a] py-24 md:py-32",children:[e.jsxs(L,{children:[e.jsx("div",{className:"grid grid-cols-12 gap-6",children:e.jsx("div",{className:"col-span-12 max-w-[46ch]",children:e.jsx("h2",{className:"text-[34px] leading-[1.1] font-semibold text-balance text-white sm:text-[42px]",style:{fontFamily:"var(--font-google-sans)"},children:"What Starchild can help with."})})}),e.jsx("div",{className:"mt-14 grid grid-cols-12 gap-6",children:Gs.map(({id:a,tag:s,title:o,copy:n,art:i,task:r},l)=>e.jsxs(p.button,{type:"button",onClick:()=>t(r),initial:{opacity:0,y:14},whileInView:{opacity:1,y:0},viewport:{once:!0,amount:.3},transition:{duration:.5,delay:l%3*.06,ease:[.16,1,.3,1]},className:"cg-card col-span-12 sm:col-span-6 lg:col-span-4",children:[e.jsx("span",{className:"cg-art","aria-hidden":"true",children:e.jsx(i,{})}),e.jsx("span",{className:"cg-tag",children:s}),e.jsxs("span",{className:"cg-title-row",children:[e.jsx("span",{className:"cg-title",children:o}),e.jsx(R,{className:"cg-arrow size-3.5 rotate-45"})]}),e.jsx("span",{className:"cg-copy",children:n})]},a))})]}),e.jsx("style",{children:`
      ...
      `})]})}function Fe({items:t}){return e.jsx("span",{className:"aw-chips",children:t.map(a=>e.jsxs("span",{className:"aw-chip",children:[e.jsx("span",{className:"aw-chip-mark","aria-hidden":"true",children:a[0]}),a]},a))})}function Us({panel:t}){return t.kind==="monitor"?e.jsxs("div",{className:"aw-card",children:[e.jsxs("div",{className:"aw-card-head",children:[e.jsx("p",{className:"aw-card-title",children:t.agentName}),e.jsxs("span",{className:"aw-status",children:[e.jsx("span",{className:"aw-live","aria-hidden":"true"}),t.cadence]})]}),e.jsxs("div",{className:"aw-section",children:[e.jsx("p",{className:"aw-label",children:"Connected sources"}),e.jsx(Fe,{items:t.sources})]}),e.jsx("div",{className:"aw-section",children:e.jsx("ul",{className:"aw-log",children:t.checks.map((a,s)=>e.jsxs(p.li,{className:a.hit?"aw-hit":void 0,initial:{opacity:0,x:-6},animate:{opacity:1,x:0},transition:{duration:.35,delay:.1+s*.09,ease:[.16,1,.3,1]},children:[e.jsx("span",{className:"aw-log-time",children:a.time}),e.jsx(ke,{className:"aw-tick size-3.5"}),a.text]},a.time))})}),e.jsxs(p.div,{className:"aw-alert",initial:{opacity:0,y:6},animate:{opacity:1,y:0},transition:{duration:.4,delay:.44,ease:[.16,1,.3,1]},children:[e.jsx("p",{className:"aw-label",children:t.alert.heading}),e.jsx("p",{className:"aw-alert-title",children:t.alert.title}),e.jsx("p",{className:"aw-alert-detail",children:t.alert.detail})]})]}):t.kind==="recurring"?e.jsxs("div",{className:"aw-card",children:[e.jsxs("div",{className:"aw-card-head",children:[e.jsx("p",{className:"aw-card-title",children:t.agentName}),e.jsxs("span",{className:"aw-status",children:[e.jsx("span",{className:"aw-live","aria-hidden":"true"}),"On"]})]}),e.jsxs("div",{className:"aw-rows",children:[e.jsxs("div",{className:"aw-row",children:[e.jsx("span",{className:"aw-row-label",children:"Uses"}),e.jsx(Fe,{items:t.uses})]}),e.jsxs("div",{className:"aw-row",children:[e.jsx("span",{className:"aw-row-label",children:"Runs"}),e.jsx("span",{className:"aw-row-value",children:t.runs})]}),e.jsxs("div",{className:"aw-row",children:[e.jsx("span",{className:"aw-row-label",children:"Output"}),e.jsx("span",{className:"aw-row-value",children:t.outputName})]})]}),e.jsxs(p.div,{className:"aw-section",initial:{opacity:0,y:6},animate:{opacity:1,y:0},transition:{duration:.4,delay:.32,ease:[.16,1,.3,1]},children:[e.jsx("p",{className:"aw-label",children:t.output.heading}),e.jsx("ul",{className:"aw-list",children:t.output.items.map((a,s)=>e.jsxs("li",{children:[e.jsx("span",{className:"aw-idx",children:s+1}),e.jsxs("span",{children:[e.jsx("span",{className:"aw-item-text",children:a.text})," ",e.jsxs("span",{className:"aw-item-note",children:["— ",a.note]})]})]},a.text))})]})]}):e.jsxs("div",{className:"aw-card",children:[e.jsxs("div",{className:"aw-card-head",children:[e.jsx("p",{className:"aw-card-title",children:t.agentName}),e.jsx("span",{className:"aw-status",children:"New agent"})]}),e.jsxs("div",{className:"aw-fields",children:[t.fields.map((a,s)=>e.jsxs(p.div,{className:"aw-field",initial:{opacity:0,y:5},animate:{opacity:1,y:0},transition:{duration:.32,delay:.08+s*.08,ease:[.16,1,.3,1]},children:[e.jsx("span",{className:"aw-field-label",children:a.label}),e.jsx("span",{className:"aw-field-value",children:a.value})]},a.label)),e.jsxs(p.div,{className:"aw-field",initial:{opacity:0,y:5},animate:{opacity:1,y:0},transition:{duration:.32,delay:.08+t.fields.length*.08,ease:[.16,1,.3,1]},children:[e.jsx("span",{className:"aw-field-label",children:"Tools"}),e.jsx(Fe,{items:t.tools})]})]}),e.jsxs(p.div,{className:"aw-footer",initial:{opacity:0},animate:{opacity:1},transition:{duration:.4,delay:.46},children:[e.jsx("span",{className:"aw-live","aria-hidden":"true"}),t.status]})]})}function Ks({onStartTask:t}){const{trackRef:a,pinned:s,index:o,selectStep:n}=Ge(fe.length),i=fe[o];return e.jsxs("section",{className:"ag-section bg-[#0a0a0a] pb-24 md:pb-32",children:[e.jsx(Ne,{trackRef:a,pinned:s,screens:fe.length,children:e.jsxs(L,{children:[e.jsx("div",{className:"grid grid-cols-12 gap-6",children:e.jsxs("div",{className:"col-span-12 max-w-[52ch]",children:[e.jsx("p",{className:"text-[12px] font-medium tracking-[0.24em] text-white/40 uppercase",style:{fontFamily:"var(--font-google-sans)"},children:"Do it once."}),e.jsx("h2",{className:"mt-4 text-[34px] leading-[1.12] font-semibold text-balance text-white sm:text-[42px]",style:{fontFamily:"var(--font-google-sans)"},children:"Let Starchild keep things moving for you."}),e.jsx("p",{className:"mt-5 text-[15px] leading-[1.6] text-white/40",style:{fontFamily:"var(--font-google-sans)"},children:"Give it something to keep track of, repeat, or take care of over time."})]})}),e.jsxs("div",{className:"mt-14 grid grid-cols-12 gap-6",children:[e.jsxs("div",{className:"col-span-12 flex flex-col gap-2 lg:col-span-4",children:[fe.map((r,l)=>{const d=l===o;return e.jsxs("button",{type:"button",onClick:()=>n(l),"aria-pressed":d,className:`ag-tab${d?" ag-tab--active":""}`,children:[e.jsx("span",{className:"ag-tab-title",children:r.label}),e.jsx(q,{initial:!1,children:d&&e.jsxs(p.span,{initial:{opacity:0,height:0},animate:{opacity:1,height:"auto"},exit:{opacity:0,height:0},transition:{duration:.28,ease:[.16,1,.3,1]},className:"block overflow-hidden",children:[e.jsx("span",{className:"ag-tab-blurb",children:r.blurb}),e.jsxs("span",{className:"ag-tab-example",children:["“",r.prompt,"”"]})]})})]},r.id)}),e.jsxs("button",{type:"button",onClick:()=>t(i.task),className:"ag-try",children:[i.task.label,e.jsx(R,{className:"size-3.5 rotate-45"})]})]}),e.jsx("div",{className:"col-span-12 lg:col-span-8",children:e.jsx(Vs,{example:i})})]})]})}),e.jsx("style",{children:`
        .ag-tab {
          display: block; width: 100%; text-align: left; cursor: pointer;
          border: 1px solid transparent; border-left: 2px solid rgba(255,255,255,.12);
          padding: 16px 18px; border-radius: 0 10px 10px 0;
      ...
      `})]})}const Tt=["a","b","c"];function so({variant:t,onChange:a}){const s=Math.max(0,Tt.indexOf(t));return e.jsxs("div",{className:"vt-wrap",children:[e.jsx("span",{className:"vt-caption",children:"Landing"}),e.jsxs("div",{className:"vt-track",role:"radiogroup","aria-label":`Landing version ${t.toUpperCase()}`,children:[e.jsx("span",{className:"vt-knob","aria-hidden":"true",style:{transform:`translateX(${s*32}px)`},children:t.toUpperCase()}),Tt.map(o=>e.jsx("button",{type:"button",role:"radio","aria-checked":o===t,"aria-label":`Landing version ${o.toUpperCase()}`,onClick:()=>a(o),className:`vt-side${o===t?" vt-side--on":""}`,children:o.toUpperCase()},o))]}),e.jsx("style",{children:`
        .vt-wrap {
