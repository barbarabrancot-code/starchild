  ...
  return (
    <section ref={sectionRef} className="cda-section" aria-labelledby="cda-title">
      ...
      <style>{`
        ...
        .cda-answer-beam { position: absolute; z-index: 1; top: 0; left: 50%; width: 560px; max-width: none; height: 420px; object-fit: fill; opacity: .9; filter: blur(3px); transform: translateX(-50%); pointer-events: none; }
