...
// product view on the right follows. What changed is the job of the section — this
// one answers "can it keep doing work for me?", not "what is it for?".
                  ...
                  <AnimatePresence initial={false}>
                    {isActive && (
                      ...
                      >
                        ...
                        <span className="ag-tab-example">“{example.prompt}”</span>
                      </motion.span>
                    )}
                  </AnimatePresence>
                </button>
