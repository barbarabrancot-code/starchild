/**
 * Version H — A with a different Conductor.
 *
 * Everything else is A, imported from the same files rather than copied: the
 * hero, the showcase, the orbit, the memory section and the closing CTA are the
 * same components, so a difference you see between the two is the Conductor
 * section and cannot be anything else. Two landings that drifted in six places
 * cannot be compared on one of them.
 *
 * What changes is ./f/ConductorSectionB — see its own note for what the third
 * pass is arguing and why the closing line stopped being about models.
 */
