 ...
 *                  else — a sentence, then the real ConnectorAdded card for
 *                  each thing still missing, no outer frame around either.
 ...
 * and each connector still needed is the real `ConnectorAdded` — asking to
 * connect and a connector arriving are the same kind of moment, so this
 * doesn't keep its own copy of that card, it just uses the real thing and
 * fires the actual `connect(id)` through its `onAdd`.
 */
