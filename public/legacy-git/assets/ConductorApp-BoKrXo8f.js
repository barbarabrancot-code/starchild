var Us=Object.defineProperty;var Xs=(t,a,n)=>a in t?Us(t,a,{enumerable:!0,configurable:!0,writable:!0,value:n}):t[a]=n;var ee=(t,a,n)=>Xs(t,typeof a!="symbol"?a+"":a,n);import{f as Oe,a as Lt,i as Qn,s as Jn,b as es,p as Ks,v as Zs,d as Qs,e as Js,g as ei,n as ts,h as ti,k as ai,u as ht,r as l,l as as,o as xa,q as ns,t as ct,M as ni,w as Vt,x as si,j as e,y as O,A as X,m,C as ii}from"./ConductorModeSection-BsfCNOM5.js";function ss(t,a){let n;const s=()=>{const{currentTime:i}=a,r=(i===null?0:i.value)/100;n!==r&&t(r),n=r};return Oe.preUpdate(s,!0),()=>Lt(s)}function oi(...t){const a=!Array.isArray(t[0]),n=a?0:-1,s=t[0+n],i=t[1+n],o=t[2+n],r=t[3+n],c=Qn(i,o,r);return a?c(s):c}function Rt(t){return typeof window>"u"?!1:t?Jn():es()}const ri=50,Ga=()=>({current:0,offset:[],progress:0,scrollLength:0,targetOffset:0,targetLength:0,containerLength:0,velocity:0}),li=()=>({time:0,x:Ga(),y:Ga()}),ci={x:{length:"Width",position:"Left"},y:{length:"Height",position:"Top"}};function _a(t,a,n,s){const i=n[a],{length:o,position:r}=ci[a],c=i.current,p=n.time;i.current=Math.abs(t[`scroll${r}`]),i.scrollLength=t[`scroll${o}`]-t[`client${o}`],i.offset.length=0,i.offset[0]=0,i.offset[1]=i.scrollLength,i.progress=Ks(0,i.scrollLength,i.current);const d=s-p;i.velocity=d>ri?0:Zs(i.current-c,d)}function di(t,a,n){_a(t,"x",a,n),_a(t,"y",a,n),a.time=n}function hi(t,a){const n={x:0,y:0};let s=t;for(;s&&s!==a;)if(Qs(s))n.x+=s.offsetLeft,n.y+=s.offsetTop,s=s.offsetParent;else if(s.tagName==="svg"){const i=s.getBoundingClientRect();s=s.parentElement;const o=s.getBoundingClientRect();n.x+=i.left-o.left,n.y+=i.top-o.top}else if(s instanceof SVGGraphicsElement){const{x:i,y:o}=s.getBBox();n.x+=i,n.y+=o;let r=null,c=s.parentNode;for(;!r;)c.tagName==="svg"&&(r=c),c=s.parentNode;s=r}else break;return n}const fa={start:0,center:.5,end:1};function Ya(t,a,n=0){let s=0;if(t in fa&&(t=fa[t]),typeof t=="string"){const i=parseFloat(t);t.endsWith("px")?s=i:t.endsWith("%")?t=i/100:t.endsWith("vw")?s=i/100*document.documentElement.clientWidth:t.endsWith("vh")?s=i/100*document.documentElement.clientHeight:t=i}return typeof t=="number"&&(s=a*t),n+s}const pi=[0,0];function gi(t,a,n,s){let i=Array.isArray(t)?t:pi,o=0,r=0;return typeof t=="number"?i=[t,t]:typeof t=="string"&&(t=t.trim(),t.includes(" ")?i=t.split(" "):i=[t,fa[t]?t:"0"]),o=Ya(i[0],n,s),r=Ya(i[1],a),o-r}const dt={Enter:[[0,1],[1,1]],Exit:[[0,0],[1,0]],Any:[[1,0],[0,1]],All:[[0,0],[1,1]]},xi={x:0,y:0};function fi(t){return"getBBox"in t&&t.tagName!=="svg"?t.getBBox():{width:t.clientWidth,height:t.clientHeight}}function mi(t,a,n){const{offset:s=dt.All}=n,{target:i=t,axis:o="y"}=n,r=o==="y"?"height":"width",c=i!==t?hi(i,t):xi,p=i===t?{width:t.scrollWidth,height:t.scrollHeight}:fi(i),d={width:t.clientWidth,height:t.clientHeight};a[o].offset.length=0;let h=!a[o].interpolate;const x=s.length;for(let g=0;g<x;g++){const f=gi(s[g],d[r],p[r],c[o]);!h&&f!==a[o].interpolatorOffsets[g]&&(h=!0),a[o].offset[g]=f}h&&(a[o].interpolate=Qn(a[o].offset,Js(s),{clamp:!1}),a[o].interpolatorOffsets=[...a[o].offset]),a[o].progress=ei(0,1,a[o].interpolate(a[o].current))}function ui(t,a=t,n){if(n.x.targetOffset=0,n.y.targetOffset=0,a!==t){let s=a;for(;s&&s!==t;)n.x.targetOffset+=s.offsetLeft,n.y.targetOffset+=s.offsetTop,s=s.offsetParent}n.x.targetLength=a===t?a.scrollWidth:a.clientWidth,n.y.targetLength=a===t?a.scrollHeight:a.clientHeight,n.x.containerLength=t.clientWidth,n.y.containerLength=t.clientHeight}function bi(t,a,n,s={}){return{measure:i=>{ui(t,s.target,n),di(t,n,i),(s.offset||s.target)&&mi(t,n,s)},notify:()=>a(n)}}const Re=new WeakMap,Va=new WeakMap,Ut=new WeakMap,Ua=new WeakMap,vt=new WeakMap,Xa=t=>t===document.scrollingElement?window:t;function is(t,{container:a=document.scrollingElement,trackContentSize:n=!1,...s}={}){if(!a)return ts;let i=Ut.get(a);i||(i=new Set,Ut.set(a,i));const o=li(),r=bi(a,t,o,s);if(i.add(r),!Re.has(a)){const p=()=>{for(const g of i)g.measure(ai.timestamp);Oe.preUpdate(d)},d=()=>{for(const g of i)g.notify()},h=()=>Oe.read(p);Re.set(a,h);const x=Xa(a);window.addEventListener("resize",h),a!==document.documentElement&&Va.set(a,ti(a,h)),x.addEventListener("scroll",h),h()}if(n&&!vt.has(a)){const p=Re.get(a),d={width:a.scrollWidth,height:a.scrollHeight};Ua.set(a,d);const h=()=>{const g=a.scrollWidth,f=a.scrollHeight;(d.width!==g||d.height!==f)&&(p(),d.width=g,d.height=f)},x=Oe.read(h,!0);vt.set(a,x)}const c=Re.get(a);return Oe.read(c,!1,!0),()=>{var x;Lt(c);const p=Ut.get(a);if(!p||(p.delete(r),p.size))return;const d=Re.get(a);Re.delete(a),d&&(Xa(a).removeEventListener("scroll",d),(x=Va.get(a))==null||x(),window.removeEventListener("resize",d));const h=vt.get(a);h&&(Lt(h),vt.delete(a)),Ua.delete(a)}}const yi=[[dt.Enter,"entry"],[dt.Exit,"exit"],[dt.Any,"cover"],[dt.All,"contain"]],Ka={start:0,end:1};function wi(t){const a=t.trim().split(/\s+/);if(a.length!==2)return;const n=Ka[a[0]],s=Ka[a[1]];if(!(n===void 0||s===void 0))return[n,s]}function vi(t){if(t.length!==2)return;const a=[];for(const n of t)if(Array.isArray(n))a.push(n);else if(typeof n=="string"){const s=wi(n);if(!s)return;a.push(s)}else return;return a}function ki(t,a){const n=vi(t);if(!n)return!1;for(let s=0;s<2;s++){const i=n[s],o=a[s];if(i[0]!==o[0]||i[1]!==o[1])return!1}return!0}function ja(t){if(!t)return{rangeStart:"contain 0%",rangeEnd:"contain 100%"};for(const[a,n]of yi)if(ki(t,a))return{rangeStart:`${n} 0%`,rangeEnd:`${n} 100%`}}const Za=new Map;function Qa(t){const a={value:0},n=is(s=>{a.value=s[t.axis].progress*100},t);return{currentTime:a,cancel:n}}function os({source:t,container:a,...n}){const{axis:s}=n;t&&(a=t);let i=Za.get(a);i||(i=new Map,Za.set(a,i));const o=n.target??"self";let r=i.get(o);r||(r={},i.set(o,r));const c=s+(n.offset??[]).join(",");return r[c]||(n.target&&Rt(n.target)?ja(n.offset)?r[c]=new ViewTimeline({subject:n.target,axis:s}):r[c]=Qa({container:a,...n}):Rt()?r[c]=new ScrollTimeline({source:a,axis:s}):r[c]=Qa({container:a,...n})),r[c]}function ji(t,a){const n=os(a),s=a.target?ja(a.offset):void 0,i=a.target?Rt(a.target)&&!!s:Rt();return t.attachTimeline({timeline:i?n:void 0,...s&&i&&{rangeStart:s.rangeStart,rangeEnd:s.rangeEnd},observe:o=>(o.pause(),ss(r=>{o.time=o.iterationDuration*r},n))})}function Ni(t){return t&&(t.target||t.offset)}function zi(t){return t.length===2}function Ci(t,a){return zi(t)||Ni(a)?is(n=>{t(n[a.axis].progress,n)},a):ss(t,os(a))}function rs(t,{axis:a="y",container:n=document.scrollingElement,...s}={}){if(!n)return ts;const i={axis:a,container:n,...s};return typeof t=="function"?Ci(t,i):ji(t,i)}const Si=()=>({scrollX:ct(0),scrollY:ct(0),scrollXProgress:ct(0),scrollYProgress:ct(0)}),He=t=>t?!t.current:!1;function Ja(t,a,n,s){return{factory:i=>{let o;const r=()=>{if(He(n)||He(s)){xa.read(r);return}o=rs(i,{...a,axis:t,container:(n==null?void 0:n.current)||void 0,target:(s==null?void 0:s.current)||void 0})};return xa.read(r),()=>{ns(r),o==null||o()}},times:[0,1],keyframes:[0,1],ease:i=>i,duration:1}}function Ti(t,a){return typeof window>"u"?!1:t?Jn()&&!!ja(a):es()}function ls({container:t,target:a,...n}={}){const s=ht(Si);Ti(a,n.offset)&&(s.scrollXProgress.accelerate=Ja("x",n,t,a),s.scrollYProgress.accelerate=Ja("y",n,t,a));const i=l.useRef(null),o=l.useRef(!1),r=l.useCallback(()=>(i.current=rs((c,{x:p,y:d})=>{s.scrollX.set(p.current),s.scrollXProgress.set(p.progress),s.scrollY.set(d.current),s.scrollYProgress.set(d.progress)},{...n,container:(t==null?void 0:t.current)||void 0,target:(a==null?void 0:a.current)||void 0}),()=>{var c;(c=i.current)==null||c.call(i)}),[t,a,JSON.stringify(n.offset)]);return as(()=>{if(o.current=!1,He(t)||He(a)){o.current=!0;return}else return r()},[r]),l.useEffect(()=>{if(!o.current)return;let c;const p=()=>{const d=He(t),h=He(a);!d&&!h&&(c=r())};return xa.read(p),()=>{ns(p),c==null||c()}},[r]),s}function Ai(t){const a=ht(()=>ct(t)),{isStatic:n}=l.useContext(ni);if(n){const[,s]=l.useState(t);l.useEffect(()=>a.on("change",s),[])}return a}function cs(t,a){const n=Ai(a()),s=()=>n.set(a());return s(),as(()=>{const i=()=>Oe.preRender(s,!1,!0),o=t.map(r=>r.on("change",i));return()=>{o.forEach(r=>r()),Lt(s)}}),n}function Mi(t){Vt.current=[],t();const a=cs(Vt.current,t);return Vt.current=void 0,a}function Ae(t,a,n,s){if(typeof t=="function")return Mi(t);if(n!==void 0&&!Array.isArray(n)&&typeof a!="function")return Ei(t,a,n,s);const r=typeof a=="function"?a:oi(a,n,s),c=Array.isArray(t)?en(t,r):en([t],([d])=>r(d)),p=Array.isArray(t)?void 0:t.accelerate;return p&&!p.isTransformed&&typeof a!="function"&&Array.isArray(n)&&(s==null?void 0:s.clamp)!==!1&&(c.accelerate={...p,times:a,keyframes:n,isTransformed:!0}),c}function en(t,a){const n=ht(()=>[]);return cs(t,()=>{n.length=0;const s=t.length;for(let i=0;i<s;i++)n[i]=t[i].get();return a(n)})}function Ei(t,a,n,s){const i=ht(()=>Object.keys(n)),o=ht(()=>({}));for(const r of i)o[r]=Ae(t,a,n[r],s);return o}const Ii={some:0,all:1};function Li(t,a,{root:n,margin:s,amount:i="some"}={}){const o=si(t),r=new WeakMap,c=d=>{d.forEach(h=>{const x=r.get(h.target);if(h.isIntersecting!==!!x)if(h.isIntersecting){const g=a(h.target,h);typeof g=="function"?r.set(h.target,g):p.unobserve(h.target)}else typeof x=="function"&&(x(h),r.delete(h.target))})},p=new IntersectionObserver(c,{root:n,rootMargin:s,threshold:typeof i=="number"?i:Ii[i]});return o.forEach(d=>p.observe(d)),()=>p.disconnect()}function xt(t,{root:a,margin:n,amount:s,once:i=!1,initial:o=!1}={}){const[r,c]=l.useState(o);return l.useEffect(()=>{if(!t.current||i&&r)return;const p=()=>(c(!0),i?void 0:()=>c(!1)),d={root:a&&a.current||void 0,margin:n,amount:s};return Li(t.current,p,d)},[a,t,n,i,s]),r}function Na({className:t}){return e.jsx("img",{src:"./images/starchild-symbol.svg",alt:"",width:32,height:32,className:t??"size-6"})}function Ri({className:t}){return e.jsx("svg",{viewBox:"0 0 24 24",fill:"none",className:t??"size-4",children:e.jsxs("g",{stroke:"currentColor",strokeWidth:"1.7",strokeLinecap:"round",children:[e.jsx("path",{d:"M3.5 8.5h11M19 8.5h1.5M3.5 15.5h5M13 15.5h7.5"}),e.jsx("circle",{cx:"16.5",cy:"8.5",r:"2.2"}),e.jsx("circle",{cx:"10.75",cy:"15.5",r:"2.2"})]})})}function $i({className:t}){return e.jsxs("svg",{viewBox:"0 0 24 24",fill:"none",className:t??"size-4",children:[e.jsx("path",{d:"M14 3H7.5A1.5 1.5 0 0 0 6 4.5v15A1.5 1.5 0 0 0 7.5 21h9a1.5 1.5 0 0 0 1.5-1.5V7z",stroke:"currentColor",strokeWidth:"1.6",strokeLinejoin:"round"}),e.jsx("path",{d:"M14 3v3.2A1.8 1.8 0 0 0 15.8 8H18",stroke:"currentColor",strokeWidth:"1.6",strokeLinejoin:"round"})]})}function fe({className:t}){return e.jsx("svg",{viewBox:"0 0 24 24",fill:"none",className:t??"size-5",children:e.jsx("path",{d:"M12 5v14M5 12h14",stroke:"currentColor",strokeWidth:"1.8",strokeLinecap:"round"})})}function Fi({className:t}){return e.jsxs("svg",{viewBox:"0 0 24 24",fill:"none",className:t??"size-4",children:[e.jsx("rect",{x:"9",y:"3",width:"6",height:"11",rx:"3",fill:"currentColor"}),e.jsx("path",{d:"M5 11a7 7 0 0 0 14 0M12 18v3",stroke:"currentColor",strokeWidth:"1.8",strokeLinecap:"round"})]})}function J({className:t}){return e.jsx("svg",{viewBox:"0 0 24 24",fill:"none",className:t??"size-4",children:e.jsx("path",{d:"M12 19V6M6 11l6-6 6 6",stroke:"currentColor",strokeWidth:"2",strokeLinecap:"round",strokeLinejoin:"round"})})}function _e({className:t}){return e.jsx("svg",{viewBox:"0 0 24 24",fill:"none",className:t??"size-3.5",children:e.jsx("path",{d:"M6 9l6 6 6-6",stroke:"currentColor",strokeWidth:"1.8",strokeLinecap:"round",strokeLinejoin:"round"})})}function ds({className:t}){return e.jsx("svg",{viewBox:"0 0 24 24",fill:"none",className:t??"size-4",children:e.jsx("path",{d:"M6 6l12 12M18 6L6 18",stroke:"currentColor",strokeWidth:"1.8",strokeLinecap:"round"})})}function Dt({className:t}){return e.jsx("svg",{viewBox:"0 0 24 24",fill:"none",className:t??"size-4",children:e.jsx("path",{d:"M19 12H5M11 18l-6-6 6-6",stroke:"currentColor",strokeWidth:"1.8",strokeLinecap:"round",strokeLinejoin:"round"})})}function hs({className:t}){return e.jsx("svg",{viewBox:"0 0 24 24",fill:"none",className:t??"size-3.5",children:e.jsx("path",{d:"M9 18l-6-6 6-6M15 6l6 6-6 6",stroke:"currentColor",strokeWidth:"1.8",strokeLinecap:"round",strokeLinejoin:"round"})})}function za({className:t}){return e.jsx("svg",{viewBox:"0 0 24 24",fill:"none",className:t??"size-3.5",children:e.jsx("path",{d:"M12 3l1.8 5.2L19 10l-5.2 1.8L12 17l-1.8-5.2L5 10l5.2-1.8L12 3z",stroke:"currentColor",strokeWidth:"1.5",strokeLinejoin:"round"})})}function ps({className:t}){return e.jsx("svg",{viewBox:"0 0 24 24",fill:"none",className:t??"size-3.5",children:e.jsx("path",{d:"M12 5l9 4.5-9 4.5-9-4.5 9-4.5zM6.5 11.5V16c0 1.4 2.5 3 5.5 3s5.5-1.6 5.5-3v-4.5",stroke:"currentColor",strokeWidth:"1.5",strokeLinejoin:"round"})})}function Ca({className:t}){return e.jsx("svg",{viewBox:"0 0 24 24",fill:"none",className:t??"size-4",children:e.jsx("path",{d:"M5 12.5l4.5 4.5L19 7",stroke:"currentColor",strokeWidth:"2",strokeLinecap:"round",strokeLinejoin:"round"})})}function gs({className:t}){return e.jsxs("svg",{viewBox:"0 0 24 24",fill:"none",className:t??"size-4",children:[e.jsx("rect",{x:"5",y:"10.5",width:"14",height:"9.5",rx:"2",stroke:"currentColor",strokeWidth:"1.7"}),e.jsx("path",{d:"M8 10.5V8a4 4 0 0 1 8 0v2.5",stroke:"currentColor",strokeWidth:"1.7",strokeLinecap:"round"})]})}function Ye({className:t}){return e.jsxs("svg",{viewBox:"0 0 24 24",fill:"none",className:t??"size-4",children:[e.jsx("circle",{cx:"11",cy:"11",r:"7",stroke:"currentColor",strokeWidth:"1.8"}),e.jsx("path",{d:"M21 21l-4.3-4.3",stroke:"currentColor",strokeWidth:"1.8",strokeLinecap:"round"})]})}function Sa({className:t}){return e.jsx("svg",{viewBox:"0 0 24 24",fill:"none",className:t??"size-3.5",children:e.jsx("path",{d:"M4 16l5.5-5.5 3.5 3.5L20 7M20 7h-4.5M20 7v4.5",stroke:"currentColor",strokeWidth:"1.7",strokeLinecap:"round",strokeLinejoin:"round"})})}function xs({className:t}){return e.jsx("svg",{viewBox:"0 0 24 24",fill:"none",className:t??"size-3.5",children:e.jsx("path",{d:"M13 3L5 13.5h5.5L11 21l8-10.5h-5.5L13 3z",stroke:"currentColor",strokeWidth:"1.5",strokeLinejoin:"round"})})}function Wi({className:t}){return e.jsxs("svg",{viewBox:"0 0 24 24",fill:"none",className:t??"size-3.5",children:[e.jsx("defs",{children:e.jsxs("radialGradient",{id:"run-dot-halo",children:[e.jsx("stop",{offset:"35%",stopColor:"#f84600",stopOpacity:"0.5"}),e.jsx("stop",{offset:"100%",stopColor:"#f84600",stopOpacity:"0"})]})}),e.jsxs("g",{className:"run-dot",children:[e.jsx("circle",{className:"run-dot-glow",cx:"12",cy:"12",r:"9",fill:"url(#run-dot-halo)"}),e.jsx("circle",{className:"run-dot-core",cx:"12",cy:"12",r:"3.4",fill:"var(--color-orange-400)"})]})]})}function fs({className:t}){return e.jsx("svg",{viewBox:"0 0 24 24",fill:"none",className:t??"size-3.5",children:e.jsx("path",{d:"M12 3v18M16.5 7.5c0-1.66-2.01-3-4.5-3s-4.5 1.34-4.5 3 2.01 2.5 4.5 3 4.5 1.34 4.5 3-2.01 3-4.5 3-4.5-1.34-4.5-3",stroke:"currentColor",strokeWidth:"1.6",strokeLinecap:"round",strokeLinejoin:"round"})})}function ft({className:t}){return e.jsxs("svg",{viewBox:"0 0 24 24",fill:"none",className:t??"size-3.5",children:[e.jsx("rect",{x:"3",y:"7.5",width:"18",height:"12",rx:"2",stroke:"currentColor",strokeWidth:"1.6"}),e.jsx("path",{d:"M8.5 7.5V6a2 2 0 0 1 2-2h3a2 2 0 0 1 2 2v1.5M3 12.5h18",stroke:"currentColor",strokeWidth:"1.6",strokeLinecap:"round"})]})}function Pi({className:t}){return e.jsx("svg",{viewBox:"0 0 24 24",fill:"none",className:t??"size-3.5",children:e.jsx("path",{d:"M12 3v18M7 21h10M4 7h5M15 7h5M4 7l-2.5 5a2.5 2.5 0 0 0 5 0L4 7zM19 7l-2.5 5a2.5 2.5 0 0 0 5 0L19 7z",stroke:"currentColor",strokeWidth:"1.5",strokeLinecap:"round",strokeLinejoin:"round"})})}function Bi({className:t}){return e.jsx("svg",{viewBox:"0 0 24 24",fill:"none",className:t??"size-3.5",children:e.jsx("path",{d:"M3 6.5a1.5 1.5 0 0 1 1.5-1.5h4l2 2h9a1.5 1.5 0 0 1 1.5 1.5v9a1.5 1.5 0 0 1-1.5 1.5h-15A1.5 1.5 0 0 1 3 17.5v-11z",stroke:"currentColor",strokeWidth:"1.6",strokeLinejoin:"round"})})}function ma({className:t}){return e.jsx("svg",{viewBox:"0 0 24 24",fill:"none",className:t??"size-5",children:e.jsx("path",{d:"M4 7h16M4 12h16M4 17h16",stroke:"currentColor",strokeWidth:"1.7",strokeLinecap:"round"})})}function Ve({className:t}){return e.jsx("svg",{viewBox:"0 0 24 24",fill:"none",className:t??"size-5",children:e.jsx("path",{d:"M10 4a2 2 0 0 1 4 0v1h3a1 1 0 0 1 1 1v3h1a2 2 0 0 1 0 4h-1v3a1 1 0 0 1-1 1h-3v-1a2 2 0 0 0-4 0v1H7a1 1 0 0 1-1-1v-3H5a2 2 0 0 1 0-4h1V6a1 1 0 0 1 1-1h3V4Z",stroke:"currentColor",strokeWidth:"1.6",strokeLinejoin:"round"})})}function ms({className:t}){return e.jsxs("svg",{viewBox:"0 0 24 24",fill:"none",className:t??"size-5",children:[e.jsx("rect",{x:"4",y:"4",width:"6.5",height:"6.5",rx:"1.6",stroke:"currentColor",strokeWidth:"1.6"}),e.jsx("rect",{x:"13.5",y:"4",width:"6.5",height:"6.5",rx:"1.6",stroke:"currentColor",strokeWidth:"1.6"}),e.jsx("rect",{x:"4",y:"13.5",width:"6.5",height:"6.5",rx:"1.6",stroke:"currentColor",strokeWidth:"1.6"}),e.jsx("rect",{x:"13.5",y:"13.5",width:"6.5",height:"6.5",rx:"1.6",stroke:"currentColor",strokeWidth:"1.6"})]})}function us({className:t}){return e.jsxs("svg",{viewBox:"0 0 24 24",fill:"none",className:t??"size-5",children:[e.jsx("path",{d:"M4 9V6a1 1 0 0 1 1-1h14a1 1 0 0 1 1 1v3",stroke:"currentColor",strokeWidth:"1.6",strokeLinecap:"round"}),e.jsx("path",{d:"M4 9h16v9a1 1 0 0 1-1 1H5a1 1 0 0 1-1-1V9Z",stroke:"currentColor",strokeWidth:"1.6",strokeLinejoin:"round"}),e.jsx("path",{d:"M9 19v-5h6v5",stroke:"currentColor",strokeWidth:"1.6",strokeLinejoin:"round"})]})}function bs({className:t}){return e.jsxs("svg",{viewBox:"0 0 24 24",fill:"none",className:t??"size-5",children:[e.jsx("path",{d:"M7 4h10v5a5 5 0 0 1-10 0V4Z",stroke:"currentColor",strokeWidth:"1.6",strokeLinejoin:"round"}),e.jsx("path",{d:"M7 6H5a2 2 0 0 0 2 3M17 6h2a2 2 0 0 1-2 3",stroke:"currentColor",strokeWidth:"1.6",strokeLinecap:"round"}),e.jsx("path",{d:"M12 14v4M9 20h6",stroke:"currentColor",strokeWidth:"1.6",strokeLinecap:"round"})]})}function ys({className:t}){return e.jsxs("svg",{viewBox:"0 0 24 24",fill:"currentColor",className:t??"size-5",children:[e.jsx("circle",{cx:"6",cy:"12",r:"1.6"}),e.jsx("circle",{cx:"12",cy:"12",r:"1.6"}),e.jsx("circle",{cx:"18",cy:"12",r:"1.6"})]})}function Di({className:t}){return e.jsxs("svg",{viewBox:"0 0 24 24",fill:"none",className:t??"size-4",children:[e.jsx("rect",{x:"3",y:"6",width:"18",height:"13",rx:"2.2",stroke:"currentColor",strokeWidth:"1.6"}),e.jsx("path",{d:"M3 10h18",stroke:"currentColor",strokeWidth:"1.6"}),e.jsx("circle",{cx:"16.5",cy:"14.5",r:"1.1",fill:"currentColor"})]})}function mt({className:t}){return e.jsxs("svg",{viewBox:"0 0 24 24",fill:"none",className:t??"size-4",children:[e.jsx("rect",{x:"3.5",y:"5",width:"17",height:"14",rx:"2.2",stroke:"currentColor",strokeWidth:"1.6"}),e.jsx("path",{d:"M14 5v14",stroke:"currentColor",strokeWidth:"1.6"})]})}function Oi({className:t}){return e.jsx("svg",{viewBox:"0 0 24 24",fill:"none",className:t??"size-4",children:e.jsx("path",{d:"m9 7-4 5 4 5M15 7l4 5-4 5",stroke:"currentColor",strokeWidth:"1.7",strokeLinecap:"round",strokeLinejoin:"round"})})}const tn={curious:{stiffness:118,damping:.6,hesitation:115,lean:.13,drag:.055},attentive:{stiffness:205,damping:.84,hesitation:55,lean:.06,drag:.028},unsettled:{stiffness:88,damping:.4,hesitation:165,lean:.19,drag:.075},composed:{stiffness:175,damping:.97,hesitation:35,lean:.03,drag:.018}},Hi=.15,Xt=6,an=.7,qi=18,Gi=1.08,nn=80,_i=320,Yi=3,st=(t,a,n)=>t<a?a:t>n?n:t;class qe{constructor({temperament:a="curious",seed:n=Math.random(),reduced:s=!1,breath:i=.022,x:o=0,y:r=0}={}){ee(this,"x");ee(this,"y");ee(this,"vx",0);ee(this,"vy",0);ee(this,"aimX");ee(this,"aimY");ee(this,"tuning");ee(this,"reduced");ee(this,"breathDepth");ee(this,"holdUntil",0);ee(this,"stretch",0);ee(this,"angle",0);ee(this,"last",0);ee(this,"accumulator",0);ee(this,"restFor",0);ee(this,"skewX");ee(this,"skewY");ee(this,"phase");ee(this,"jitter");this.tuning=tn[a],this.reduced=s,this.breathDepth=s?0:i,this.x=this.aimX=o,this.y=this.aimY=r,this.skewX=1+(n-.5)*.13,this.skewY=1-(n-.5)*.13,this.phase=n*Math.PI*2,this.jitter=.75+n*.5}setTemperament(a){this.tuning=tn[a]}setReduced(a){this.reduced=a,a&&(this.x=this.aimX,this.y=this.aimY,this.vx=this.vy=0,this.stretch=0,this.breathDepth=0)}place(a,n){this.x=this.aimX=a,this.y=this.aimY=n,this.vx=this.vy=0,this.stretch=0,this.holdUntil=0}aim(a,n,s=performance.now()){if(this.reduced){this.x=this.aimX=a,this.y=this.aimY=n;return}Math.hypot(a-this.aimX,n-this.aimY)>qi&&this.isResting()&&(this.holdUntil=s+this.tuning.hesitation*this.jitter),this.aimX=a,this.aimY=n}unbalance(a=1){if(this.reduced)return;const n=this.phase+a;this.vx+=Math.cos(n)*90*a,this.vy+=Math.sin(n)*74*a}isResting(){return Math.hypot(this.vx,this.vy)<Xt&&Math.hypot(this.aimX-this.x,this.aimY-this.y)<an*4}step(a){if(this.reduced)return this.x=this.aimX,this.y=this.aimY,{x:this.x,y:this.y,vx:0,vy:0,speed:0,stretch:0,angle:0,breath:1,settled:!0};this.last||(this.last=a);const n=st((a-this.last)/1e3,0,.1);this.last=a;const{stiffness:s,damping:i,lean:o,drag:r}=this.tuning,c=a<this.holdUntil,p=c?this.x+(this.aimX-this.x)*o:this.aimX,d=c?this.y+(this.aimY-this.y)*o:this.aimY,h=st(this.restFor/.42,0,1),x=i+(Gi-i)*h,g=Math.hypot(p-this.x,d-this.y),f=1+Yi*st((g-nn)/(_i-nn),0,1);this.accumulator+=n;const u=1/240;let b=0;for(;this.accumulator>=u&&b++<60;){this.accumulator-=u;const S=s*this.skewX*f,w=s*this.skewY*f,L=2*x*Math.sqrt(S),W=2*x*Math.sqrt(w);this.vx+=(S*(p-this.x)-L*this.vx)*u,this.vy+=(w*(d-this.y)-W*this.vy)*u,this.x+=this.vx*u,this.y+=this.vy*u}const y=Math.hypot(this.vx,this.vy),v=y<Xt&&Math.hypot(this.aimX-this.x,this.aimY-this.y)<an;this.restFor=v?this.restFor+n:0;const k=st(y*r*.01,0,Hi),N=k>this.stretch?.22:.1;this.stretch+=(k-this.stretch)*st(N*n*60,0,1),y>Xt&&(this.angle=Math.atan2(this.vy,this.vx));const C=this.breathDepth?1+Math.sin(a/1e3/3.9*Math.PI*2+this.phase)*this.breathDepth*h:1;return{x:this.x,y:this.y,vx:this.vx,vy:this.vy,speed:y,stretch:this.stretch,angle:this.angle,breath:C,settled:v&&this.stretch<.004}}isQuiet(a){return a.settled&&!this.breathDepth}}function Ot(t,a=0,n=0){const s=t.angle*180/Math.PI,i=1+t.stretch,o=1-t.stretch*.62,r=t.breath;return`translate3d(${(t.x+a).toFixed(2)}px, ${(t.y+n).toFixed(2)}px, 0) rotate(${s.toFixed(2)}deg) scale(${(i*r).toFixed(4)}, ${(o*r).toFixed(4)}) rotate(${(-s).toFixed(2)}deg)`}function oe(){const[t,a]=l.useState(()=>typeof window>"u"?!1:window.matchMedia("(prefers-reduced-motion: reduce)").matches);return l.useEffect(()=>{const n=window.matchMedia("(prefers-reduced-motion: reduce)"),s=()=>a(n.matches);return s(),n.addEventListener("change",s),()=>n.removeEventListener("change",s)},[]),t}function Ht(t={}){const{temperament:a="composed",seed:n,breath:s=.022,offsetX:i=0,offsetY:o=0,onFrame:r,observe:c=!0}=t,p=l.useRef(null),d=oe(),h=l.useMemo(()=>new qe({temperament:a,seed:n,breath:s,reduced:d}),[]),x=l.useRef(0),g=l.useRef(!1),f=l.useRef(!0),u=l.useRef(r);u.current=r,l.useEffect(()=>{h.setReduced(d),h.setTemperament(a)},[h,d,a]);const b=l.useCallback(()=>{if(g.current||!f.current)return;g.current=!0;const v=k=>{var S;const N=h.step(k),C=p.current;if(C&&(C.style.transform=Ot(N,i,o)),(S=u.current)==null||S.call(u,N),h.isQuiet(N)||!f.current){g.current=!1;return}x.current=requestAnimationFrame(v)};x.current=requestAnimationFrame(v)},[h,i,o]);l.useEffect(()=>{const v=p.current;if(!v)return;let k;c&&typeof IntersectionObserver<"u"&&(k=new IntersectionObserver(([C])=>{f.current=C.isIntersecting,C.isIntersecting&&b()},{threshold:0}),k.observe(v));const N=()=>{f.current=!document.hidden,document.hidden||b()};return document.addEventListener("visibilitychange",N),b(),()=>{k==null||k.disconnect(),document.removeEventListener("visibilitychange",N),cancelAnimationFrame(x.current),g.current=!1}},[b,c]);const y=l.useMemo(()=>({aim:(v,k)=>{h.aim(v,k),b()},place:(v,k)=>{h.place(v,k),b()},setTemperament:v=>h.setTemperament(v),unbalance:v=>{h.unbalance(v),b()},wake:b}),[h,b]);return{ref:p,controller:y}}function Ta(t,a,n=3.4,s=!1){l.useEffect(()=>{if(!a||s)return;let i;const o=()=>{const r=Math.random()*Math.PI*2,c=n*(.35+Math.random()*.65);t.aim(Math.cos(r)*c,Math.sin(r)*c),i=window.setTimeout(o,380+Math.random()*620)};return i=window.setTimeout(o,120),()=>window.clearTimeout(i)},[t,a,n,s])}const Vi={idle:"composed",listening:"attentive",acknowledging:"attentive",thinking:"unsettled",settled:"composed"},Ui={idle:[0,0],listening:[0,2.6],acknowledging:[0,1.2],thinking:[0,0],settled:[0,0]},Xi={idle:null,listening:"sd-attend .42s cubic-bezier(.16,1,.3,1)",acknowledging:"sd-acknowledge .52s cubic-bezier(.34,.8,.3,1)",thinking:"sd-consider .72s cubic-bezier(.4,0,.2,1)",settled:"sd-recompose .62s cubic-bezier(.16,1,.3,1)"};function Aa({state:t="idle",depth:a=0,size:n=18}){const s=oe(),i=l.useRef(null),{ref:o,controller:r}=Ht({temperament:Vi[t],breath:t==="idle"?.03:.012});l.useEffect(()=>{if(t==="thinking")return;const[h,x]=Ui[t];r.aim(h,x)},[r,t]),Ta(r,t==="thinking",3.2,s),l.useEffect(()=>{const h=i.current,x=Xi[t];!h||!x||s||(h.style.animation="none",h.offsetWidth,h.style.animation=x)},[t,s]);const c=10+a*26,p=.1+a*.22,d=n*(2+a*.9);return e.jsxs("span",{className:"relative inline-flex items-center justify-center",style:{width:n*3,height:n*3},children:[e.jsx("span",{"aria-hidden":"true",className:"sd-halo",style:{width:d,height:d,opacity:p}}),e.jsx("span",{ref:i,className:"sd-beat",children:e.jsx("span",{ref:o,"aria-hidden":"true",className:"sd-core",style:{width:n,height:n,boxShadow:`0 0 ${c}px rgba(248,70,0,.7)`}})})]})}const sn=.34,on=.15,$e=860,kt=560,jt=14;function Ki({targetRef:t,image:a}){const n=l.useRef(null),s=l.useRef(null),i=l.useRef(null),o=l.useRef(null);return l.useEffect(()=>{const r=t.current,c=n.current;if(!r||!c||!window.matchMedia("(hover: hover) and (pointer: fine)").matches)return;const d=window.matchMedia("(prefers-reduced-motion: reduce)").matches;let h=0,x=0,g=0,f=0,u=0,b=0,y=!1,v=0;const k=()=>{var L,W,D,j;(L=o.current)==null||L.style.setProperty("transform",`translate3d(${g-jt/2}px, ${f-jt/2}px, 0)`),(W=i.current)==null||W.style.setProperty("transform",`translate3d(${u-kt/2}px, ${b-kt/2}px, 0)`),(D=s.current)==null||D.style.setProperty("--mx",`${u-$e/2}px`),(j=s.current)==null||j.style.setProperty("--my",`${b-$e/2}px`)},N=()=>{g+=(h-g)*sn,f+=(x-f)*sn,u+=(g-u)*on,b+=(f-b)*on,k(),v=requestAnimationFrame(N)},C=L=>{const W=r.getBoundingClientRect();if(h=L.clientX-W.left,x=L.clientY-W.top,!y){if(y=!0,g=u=h,f=b=x,k(),d)return;v=requestAnimationFrame(N)}d&&(g=u=h,f=b=x,k())},S=()=>c.classList.add("hs-on"),w=()=>{c.classList.remove("hs-on"),cancelAnimationFrame(v),v=0,y=!1};return r.addEventListener("pointermove",C),r.addEventListener("pointerenter",S),r.addEventListener("pointerleave",w),r.classList.add("hs-host"),()=>{r.removeEventListener("pointermove",C),r.removeEventListener("pointerenter",S),r.removeEventListener("pointerleave",w),r.classList.remove("hs-host"),cancelAnimationFrame(v)}},[t]),e.jsxs("div",{ref:n,className:"hs-root","aria-hidden":"true",children:[e.jsxs("div",{className:"hs-light-layer",children:[e.jsx("div",{ref:s,className:"hs-lit"}),e.jsx("div",{ref:i,className:"hs-glow"})]}),e.jsx("div",{className:"hs-cursor-layer",children:e.jsx("div",{ref:o,className:"hs-dot"})}),e.jsx("style",{children:`
...
def parse_config(path):
    ...
    `})]})}function so({onEnterGuest:t,onStartTask:a}){const[n,s]=l.useState(""),i=()=>t(n.trim()||void 0);return e.jsxs("div",{children:[e.jsxs(m.div,{initial:{opacity:0,y:10},animate:{opacity:1,y:0},transition:{duration:.45},className:"mb-5 flex items-center gap-2",children:[e.jsx(Aa,{state:"idle",size:10}),e.jsx("span",{className:"text-[12px] font-medium tracking-[0.16em] text-[#ffa940] uppercase",style:{fontFamily:"var(--font-google-sans)"},children:"An AI that gets to know you"})]}),e.jsx(m.h1,{initial:{opacity:0,y:12},animate:{opacity:1,y:0},transition:{duration:.6,ease:[.16,1,.3,1]},className:"max-w-[640px] text-[42px] leading-[1.08] font-semibold text-white sm:text-[56px]",style:{fontFamily:"var(--font-google-sans)"},children:"Starchild understands your context — and helps you get things done."}),e.jsx(m.p,{initial:{opacity:0,y:12},animate:{opacity:1,y:0},transition:{duration:.55,delay:.08},className:"mt-5 max-w-[520px] text-[17px] leading-relaxed text-white/72",style:{fontFamily:"var(--font-google-sans)"},children:"You don't need the perfect question. Start anywhere — no account needed."}),e.jsxs(m.div,{initial:{opacity:0,y:16},animate:{opacity:1,y:0},transition:{duration:.55,delay:.15},className:"mt-8 max-w-[600px] rounded-[22px] border border-white/12 bg-white/[0.06] p-4 backdrop-blur-sm transition-colors focus-within:border-white/30",children:[e.jsx("input",{value:n,onChange:o=>s(o.target.value),onKeyDown:o=>{o.key==="Enter"&&i()},placeholder:"What's on your mind?",className:"w-full bg-transparent text-[16px] text-white placeholder:text-white/35 focus:outline-none",style:{fontFamily:"var(--font-google-sans)"}}),e.jsx("div",{className:"mt-4 flex items-center justify-end",children:e.jsxs("button",{type:"button",onClick:i,className:"flex items-center gap-2 rounded-full bg-[#f84600] px-5 py-2.5 text-[13.5px] font-medium text-white transition-transform hover:scale-[1.03]",style:{fontFamily:"var(--font-google-sans)"},children:["Meet Starchild",e.jsx(J,{className:"size-3.5 rotate-90"})]})})]}),e.jsx(m.div,{initial:{opacity:0},animate:{opacity:1},transition:{duration:.55,delay:.28},className:"mt-6",children:e.jsx(ut,{onStartTask:a})})]})}const io="./images/empresas.svg",oo=6;function Cs(){return e.jsxs("section",{className:"uw-section bg-[#0a0a0a] py-20 md:py-24",children:[e.jsx(O,{children:e.jsx("div",{className:"grid grid-cols-12 gap-6",children:e.jsx("p",{className:"col-span-12 text-center text-[13px] tracking-[0.16em] text-white/40 uppercase",style:{fontFamily:"var(--font-google-sans)"},children:"Trusted by people at"})})}),e.jsx("div",{className:"uw-viewport mt-10","aria-hidden":"true",children:e.jsx("div",{className:"uw-track",children:Array.from({length:oo},(t,a)=>e.jsx("img",{src:io,alt:"",className:"uw-strip"},a))})}),e.jsx("style",{children:`
      ...
      `})]})}const xo=[{name:"OpenAI",file:"OpenAI.svg",w:148,h:40,size:24},{name:"SpaceX AI",file:"Spacexai.svg",w:215,h:29,size:19},{name:"Claude",file:"Claude.svg",w:160,h:34,size:24},{name:"Gemini",file:"Frame374.svg",w:151,h:34,size:24},{name:"Kimi",file:"Kimi.svg",w:118,h:40,size:24}],fo=[{name:"DeepSeek",file:"Deepseek.svg",w:206,h:33,size:21},{name:"Qwen",file:"Frame375.svg",w:137,h:40,size:24},{name:"MiniMax",file:"Frame376.svg",w:177,h:42,size:24},{name:"Z",file:"Zai.svg",w:40,h:40,size:22}],mo=4,uo=["what matters to you","how you like to be helped","what you're working through","what you keep coming back to"],bo=[{title:"No model-hopping",desc:"Stop guessing which AI to use."},{title:"Better context",desc:"The model gets the information it actually needs."},{title:"Less waste",desc:"Starchild can avoid sending unnecessary context to expensive models."},{title:"Always adapting",desc:"As models change, you don't have to rebuild your workflow around them."}],dn=.04,yo=.2,hn=.24,wo=.58,zt=.66,pn=.96,vo=.56,ko=.62,jo=3520,ve=t=>t<0?0:t>1?1:t,ke=(t,a,n)=>t+(a-t)*n,ua=t=>t<.5?2*t*t:1-(-2*t+2)**2/2;function gn(t,a){const n=t.length-1;if(n<1)return t[0];const s=ve(a)*n,i=Math.min(n-1,Math.floor(s)),o=ua(s-i);return{x:ke(t[i].x,t[i+1].x,o),y:ke(t[i].y,t[i+1].y,o)}}function it(t,a,n){const s=t.getBoundingClientRect();return{left:(s.left-a.left)/n,top:(s.top-a.top)/n,width:s.width/n,height:s.height/n}}function xn(t,a){return{x:Math.max(t.left,Math.min(a.x,t.left+t.width)),y:Math.max(t.top,Math.min(a.y,t.top+t.height))}}function Zt(t,a,n,s){if(!t)return 0;const i=Math.hypot(n.x-a.x,n.y-a.y);return t.setAttribute("x1",`${a.x}`),t.setAttribute("y1",`${a.y}`),t.setAttribute("x2",`${n.x}`),t.setAttribute("y2",`${n.y}`),t.style.strokeDasharray=`${i}`,t.style.strokeDashoffset=s?"0":`${i}`,i}function Qt(t,a,n,s,i){if(!t||a<=0)return;const o=(i.x-n.x)*(s.x-n.x)+(i.y-n.y)*(s.y-n.y);t.style.strokeDashoffset=`${(a*(1-ve(o/(a*a)))).toFixed(2)}`}function fn({marks:t,reverse:a}){return e.jsx("div",{className:"ky-marquee",children:e.jsx("div",{className:`ky-track${a?" ky-track--reverse":""}`,children:Array.from({length:mo}).flatMap((n,s)=>t.map(i=>e.jsx("img",{className:"ky-mark",src:`./images/carousel/${i.file}`,alt:s===0?i.name:"",style:{height:i.size,width:i.size*(i.w/i.h)}},`${s}-${i.file}`)))})})}function mn({label:t,innerRef:a,className:n="",children:s}){return e.jsxs("div",{className:`ky-panel ${n}`,ref:a,children:[e.jsx("p",{className:"ky-panel-label",children:t}),s]})}function bt({showBenefits:t=!0}={}){const a=l.useRef(null),n=l.useRef(null),s=l.useRef(null),i=l.useRef(null),o=l.useRef(null),r=l.useRef(null),c=l.useRef(null),p=l.useRef(null),d=l.useRef(null),h=l.useRef(null),x=l.useRef(null),g=l.useRef({a:0,b:0,c:0}),f=l.useRef(null),u=l.useRef(null),b=l.useRef({a:[],b:[]}),y=l.useRef(null),v=l.useRef(null),k=l.useRef(null),N=l.useRef(null),C=l.useRef(0),[S,w]=l.useState("waiting"),[L,W]=l.useState(!1),[D,j]=l.useState(!1),$=l.useRef(!1);l.useEffect(()=>{const F=window.matchMedia("(prefers-reduced-motion: reduce)"),B=()=>j(F.matches);B(),F.addEventListener("change",B);const _=()=>{const U=n.current,Z=s.current,H=i.current,z=o.current,Y=r.current;if(!U||!Z||!H||!z||!Y)return;const T=U.getBoundingClientRect(),q=U.offsetWidth?T.width/U.offsetWidth:1,I=it(z,T,q),M={x:I.left+I.width/2,y:I.top+I.height/2},R=it(Y,T,q),V={conductor:M,you:xn(it(Z,T,q),M),models:xn(it(H,T,q),M),result:{x:R.left+R.width/2,y:R.top}};c.current=V;const G=ae=>{if(!ae)return[];const ne=it(ae,T,q);return[{x:ne.left+ne.width/2,y:ne.top+ne.height/2}]};b.current={a:[...G(f.current),V.you],b:[...G(u.current),V.models]};const te=p.current;if(te){te.setAttribute("viewBox",`0 0 ${U.offsetWidth} ${U.offsetHeight}`);const ae=F.matches;g.current={a:Zt(d.current,V.you,V.conductor,ae),b:Zt(h.current,V.models,V.conductor,ae),c:Zt(x.current,V.conductor,V.result,ae)}}};_(),window.addEventListener("resize",_);const Q=new ResizeObserver(_);return n.current&&Q.observe(n.current),()=>{Q.disconnect(),window.removeEventListener("resize",_),F.removeEventListener("change",B)}},[]),l.useEffect(()=>{const F=n.current;if(!F)return;if(D){E(1);return}let B=0,_=0;const Q=Z=>{_||(_=Z);const H=ve((Z-_)/jo);E(H),H<1&&(B=requestAnimationFrame(Q))},U=new IntersectionObserver(([Z])=>{!Z.isIntersecting||$.current||($.current=!0,U.disconnect(),B=requestAnimationFrame(Q))},{threshold:.4});return U.observe(F),()=>{U.disconnect(),cancelAnimationFrame(B)}},[D]),l.useEffect(()=>{if(D)return;const F=n.current;if(!F)return;N.current??(N.current={a:new qe({temperament:"attentive",seed:.21,breath:0}),b:new qe({temperament:"attentive",seed:.21,breath:0}),c:new qe({temperament:"attentive",seed:.44,breath:0})});const{a:B,b:_,c:Q}=N.current;let U=0,Z=!1,H=!1;const z=I=>{const M=c.current;if(!M){U=requestAnimationFrame(z);return}const R=C.current,V=ve((R-dn)/(yo-dn)),G=ua(ve((R-hn)/(wo-hn))),te=ua(ve((R-zt)/(pn-zt))),ae=gn(b.current.a,V),ne=gn(b.current.b,V),be=ke(ae.x,M.conductor.x,G),Ne=ke(ae.y,M.conductor.y,G),ze=ke(ne.x,M.conductor.x,G),ge=ke(ne.y,M.conductor.y,G),re=ke(M.conductor.x,M.result.x,te),xe=ke(M.conductor.y,M.result.y,te);Z||(Z=!0,B.place(be,Ne),_.place(ze,ge),Q.place(re,xe)),B.aim(be,Ne,I),_.aim(ze,ge,I),Q.aim(re,xe,I);const K=G>.94?(1-G)/.06:1,Ce=G<=0?0:Math.min(1,G/.05)*K,Gt=te<=0?0:te>.93?(1-te)/.07:Math.min(1,te/.08),yt=B.step(I),Qe=_.step(I),Je=Q.step(I),et=(tt,Ie,at)=>{tt&&(tt.style.transform=Ot(Ie),tt.style.opacity=`${ve(at)}`)};et(y.current,yt,Ce),et(v.current,Qe,Ce),et(k.current,Je,Gt),Qt(d.current,g.current.a,M.you,M.conductor,yt),Qt(h.current,g.current.b,M.models,M.conductor,Qe),Qt(x.current,g.current.c,M.conductor,M.result,Je),U=requestAnimationFrame(z)},Y=()=>{H||(H=!0,U=requestAnimationFrame(z))},T=()=>{H=!1,cancelAnimationFrame(U)},q=new IntersectionObserver(([I])=>I.isIntersecting?Y():T(),{threshold:0});return q.observe(F),()=>{q.disconnect(),T()}},[D]);const E=F=>{C.current=F;const B=ve((F-zt)/(pn-zt));w(B>.88?"resolved":B>0?"resolving":F>=ko?"deciding":F>=vo?"absorbing":"waiting"),W(B>.88)},A=D||L;return e.jsxs("section",{className:"ky-section bg-[#0a0a0a] py-[var(--section-pad)]",children:[e.jsx(Ma,{trackRef:a,pinned:!1,screens:2.1,children:e.jsxs(O,{children:[e.jsx("div",{className:"grid grid-cols-12 gap-6",children:e.jsxs("div",{className:"col-span-12 mx-auto max-w-[52ch] text-center",children:[e.jsx(m.h2,{initial:{opacity:0,y:14},whileInView:{opacity:1,y:0},viewport:{once:!0,amount:.5},transition:{duration:.55,ease:[.16,1,.3,1]},className:"text-[34px] leading-[1.1] font-semibold text-balance text-white sm:text-[44px]",style:{fontFamily:"var(--font-google-sans)"},children:"It knows you. It knows AI."}),e.jsx("p",{className:"mt-5 text-[18px] leading-[1.6] tracking-[var(--tracking-body)] text-balance text-[var(--color-text-body)]",style:{fontFamily:"var(--font-google-sans)"},children:"Starchild learns how you work and chooses the right AI for each task."})]})}),e.jsx("div",{className:"mt-16 grid grid-cols-12 gap-6",children:e.jsx("div",{className:"col-span-12",children:e.jsxs("div",{className:"ky-stage",ref:n,children:[e.jsxs("div",{className:"ky-flow",children:[e.jsx(mn,{label:"You",innerRef:s,className:"ky-panel--you",children:e.jsx("div",{className:"ky-lines",ref:f,children:uo.map(F=>e.jsx("p",{className:"ky-line",children:F},F))})}),e.jsxs("div",{className:"ky-conductor","data-phase":D?"resolved":S,ref:o,children:[e.jsx("p",{className:"ky-conductor-label",children:"Conductor"}),e.jsx("span",{className:"ky-aura","aria-hidden":"true"}),e.jsx("span",{className:"ky-core","aria-hidden":"true"})]}),e.jsx(mn,{label:"Available models",innerRef:i,className:"ky-panel--models",children:e.jsxs("div",{className:"ky-marquees",ref:u,children:[e.jsx(fn,{marks:xo}),e.jsx(fn,{marks:fo,reverse:!0})]})})]}),e.jsxs("div",{className:`ky-result${A?" ky-result--lit":""}`,ref:r,children:[e.jsx("p",{className:"ky-result-label",children:"Result"}),e.jsx("p",{className:"ky-result-text",children:"One answer, routed to the right model."})]}),e.jsxs("svg",{className:"ky-trails",ref:p,"aria-hidden":"true",children:[e.jsx("line",{ref:d,className:"ky-trail"}),e.jsx("line",{ref:h,className:"ky-trail"}),e.jsx("line",{ref:x,className:"ky-trail"})]}),!D&&e.jsxs("div",{className:"ky-dots","aria-hidden":"true",children:[e.jsx("span",{ref:y,className:"ky-dot"}),e.jsx("span",{ref:v,className:"ky-dot"}),e.jsx("span",{ref:k,className:"ky-dot ky-dot--result"})]})]})})})]})}),t&&e.jsx(O,{children:e.jsx("div",{className:"mt-20 grid grid-cols-12 gap-6",children:bo.map((F,B)=>e.jsx(m.div,{initial:{opacity:0,y:14},whileInView:{opacity:1,y:0},viewport:{once:!0,amount:.4},transition:{duration:.5,delay:B*.06,ease:[.16,1,.3,1]},className:"col-span-12 sm:col-span-6 lg:col-span-3",children:e.jsxs("div",{className:"ky-benefit",children:[e.jsx("h3",{className:"ky-benefit-title",children:F.title}),e.jsx("p",{className:"ky-benefit-desc",children:F.desc})]})},F.title))})}),e.jsx("style",{children:`
      ...
      `})]})}let Ia=[];function Bo(t){Ia=t}function un(){Ia=[]}function Do(t,a,n,s){let i=0,o=0,r=n,c=!1;for(const h of Ia){const x=Math.hypot(h.x-t,h.y-a);x<r&&(r=x,i=h.x,o=h.y,c=!0)}if(!c)return{x:t,y:a,hold:0};const p=1-r/n,d=s*p*p;return{x:t+(i-t)*d,y:a+(o-a)*d,hold:d}}const ye=11,bn=.55,Oo=1.15,ea=30,ta=300,Ho=26,Ft=26,Fe=[150,168,196],We=[255,255,255],aa=[255,146,62],yn=.15,qo=.08,St=14,Go=92,_o=.75,Yo={input:"attentive",cta:"composed",chip:"curious"};function Vo(){return Array.from({length:Ft},(t,a)=>{const n=a/(Ft-1),s=Math.max(0,n-.72)/.28,i=Math.round(Fe[0]+(We[0]-Fe[0])*n+(aa[0]-We[0])*s*.55),o=Math.round(Fe[1]+(We[1]-Fe[1])*n+(aa[1]-We[1])*s*.55),r=Math.round(Fe[2]+(We[2]-Fe[2])*n+(aa[2]-We[2])*s*.55),c=.05+.85*Math.pow(n,1.6);return{color:`rgba(${i},${o},${r},${c.toFixed(3)})`,size:Oo+1.5*Math.pow(n,2),points:[]}})}function Uo({targetRef:t}){const a=l.useRef(null),n=l.useRef(null);return l.useEffect(()=>{const s=t.current,i=a.current,o=i==null?void 0:i.getContext("2d");if(!s||!i||!o)return;const r=window.matchMedia("(prefers-reduced-motion: reduce)").matches,c=window.matchMedia("(hover: hover) and (pointer: fine)").matches,p=Vo();c&&s.classList.add("hero-c--fine");let d=0,h=0,x=0,g=0,f=[];const u=new qe({temperament:"curious",reduced:r,breath:.05});let b=-9999,y=-9999,v=-9999,k=-9999,N=-9999,C=-9999,S=0,w=0,L=!1,W=null,D=0,j=!1;const $=performance.now(),E=(I,M,R)=>Math.sin(I*.0062+M*.0038+R*.19)+Math.sin(I*.0029-M*.0071-R*.14)*.85+Math.sin((I+M)*.0042+R*.09)*.6,A=I=>{const M=(I-$)/1e3;if(o.clearRect(0,0,d,h),S>.01){const R=o.createRadialGradient(N,C,0,N,C,ta*1.6);R.addColorStop(0,`rgba(248,70,0,${(.11*S).toFixed(3)})`),R.addColorStop(.45,`rgba(248,70,0,${(.04*S).toFixed(3)})`),R.addColorStop(1,"rgba(248,70,0,0)"),o.fillStyle=R,o.fillRect(0,0,d,h)}for(const R of p)R.points.length=0;for(const R of f){const V=E(R.x,R.y,M);let G=R.x+V*5*R.depth,te=R.y+V*ea*R.depth,ne=.06+.62*Math.pow(Math.max(0,Math.cos(V*1.9+R.seed*.35)),7)*R.depth+.05*R.seed;if(S>.01){const Ne=G-N,ze=te-C,ge=Math.hypot(Ne,ze);if(ge<ta){const re=1-ge/ta,xe=re*re*S;if(ne+=xe*1.1,ge>.001){const K=xe*Ho;G+=Ne/ge*K,te+=ze/ge*K}}}const be=Math.min(Ft-1,Math.max(0,Math.round(ne*(Ft-1))));p[be].points.push(G,te)}for(const R of p){if(R.points.length===0)continue;o.fillStyle=R.color;const V=R.size/2;for(let G=0;G<R.points.length;G+=2)o.fillRect(R.points[G]-V,R.points[G+1]-V,R.size,R.size)}},F=I=>{const M=n.current;!M||!c||(M.style.transform=Ot(I,-St/2,-St/2),M.style.opacity=`${S}`)},B=()=>{const I=Math.ceil(d/ye)+2,M=Math.ceil((h+ea*2)/ye)+2,R=[];for(let V=0;V<M;V++)for(let G=0;G<I;G++){const te=Math.random(),ae=G*ye-ye+(Math.random()-.5)*ye*2*bn,ne=V*ye-ye-ea+(Math.random()-.5)*ye*2*bn,be=.35+.65*Math.min(1,Math.max(0,ne/Math.max(1,h)));R.push({x:ae,y:ne,depth:be,seed:te})}f=R},_=()=>{const I=s.getBoundingClientRect();x=I.left,g=I.top;const M=Math.min(window.devicePixelRatio||1,1.75);d=Math.max(1,Math.round(I.width)),h=Math.max(1,Math.round(I.height)),i.width=Math.round(d*M),i.height=Math.round(h*M),i.style.width=`${d}px`,i.style.height=`${h}px`,o.setTransform(M,0,0,M,0,0),B(),A(performance.now())},Q=I=>{const M=Do(b+x,y+g,Go,_o);u.aim(M.x-x,M.y-g,I);const R=u.step(I);v=R.x,k=R.y,N+=(v-N)*yn,C+=(k-C)*yn,S+=(w-S)*qo,A(I),F(R),D=requestAnimationFrame(Q)},U=()=>{j||r||(j=!0,D=requestAnimationFrame(Q))},Z=()=>{j=!1,cancelAnimationFrame(D)},H=I=>{const M=s.getBoundingClientRect();x=M.left,g=M.top,b=I.clientX-M.left,y=I.clientY-M.top,L||(L=!0,u.place(b,y),v=N=b,k=C=y),w=1;const R=I.target instanceof Element?I.target.closest("[data-presence]"):null,V=(R==null?void 0:R.getAttribute("data-presence"))??null;V!==W&&(W=V,u.setTemperament(V?Yo[V]??"curious":"curious")),r&&(v=N=b,k=C=y,S=1,A(performance.now()),F(u.step(performance.now())))},z=()=>{w=0,L=!1,W=null,u.setTemperament("curious"),r&&(S=0,A(performance.now()),F(u.step(performance.now())))},Y=new IntersectionObserver(([I])=>I.isIntersecting?U():Z(),{threshold:0});Y.observe(s);const T=()=>document.hidden?Z():U(),q=new ResizeObserver(_);return q.observe(s),s.addEventListener("pointermove",H),s.addEventListener("pointerleave",z),document.addEventListener("visibilitychange",T),_(),()=>{Y.disconnect(),q.disconnect(),s.removeEventListener("pointermove",H),s.removeEventListener("pointerleave",z),document.removeEventListener("visibilitychange",T),s.classList.remove("hero-c--fine"),Z()}},[t]),e.jsxs(e.Fragment,{children:[e.jsx("canvas",{ref:a,className:"absolute inset-0 z-0 h-full w-full","aria-hidden":"true"}),e.jsx("div",{className:"pm-cursor-layer","aria-hidden":"true",children:e.jsx("span",{ref:n,className:"pm-dot"})}),e.jsx("style",{children:`
      ...
      `})]})}const Xo="./icons/",wn=[{radius:.4,period:96},{radius:.63,period:148},{radius:.86,period:205}],vn=[{id:"openai",name:"OpenAI",file:"openai.svg",ring:0,angle:18},{id:"gemini",name:"Gemini",file:"gemini.svg",ring:0,angle:205},{id:"grok",name:"Grok",file:"xai.svg",ring:1,angle:96},{id:"deepseek",name:"DeepSeek",file:"deepseek.svg",ring:1,angle:262},{id:"kimi",name:"Kimi",file:"kimi.svg",ring:2,angle:148},{id:"zai",name:"Z.ai",file:"zai.svg",ring:2,angle:322}],kn=6,Ko=30,Zo=-10;function Ts(){const t=l.useRef(null),a=l.useRef(null),n=l.useRef([]),s=l.useRef(null),[i,o]=l.useState(null),r=l.useRef(null);r.current=i;const c=l.useRef(null);return l.useEffect(()=>{var p;(p=c.current)==null||p.call(c,performance.now())},[i]),l.useEffect(()=>{const p=t.current,d=a.current;if(!p||!d)return;const h=window.matchMedia("(prefers-reduced-motion: reduce)").matches;let x=0,g=0,f=!1,u=0,b=0;const y=()=>{x=p.clientWidth/2},v=j=>{const $=b?Math.min((j-b)/1e3,.1):0;b=j,!r.current&&!h&&(u+=$);const E=[];vn.forEach((A,F)=>{const B=n.current[F];if(!B)return;const _=wn[A.ring],Q=h?0:u/_.period,U=(A.angle/360+Q)%1*Math.PI*2,Z=_.radius*x,H=Math.cos(U)*Z,z=Math.sin(U)*Z;B.style.transform=`translate3d(${H.toFixed(2)}px, ${z.toFixed(2)}px, 0)`,E.push(B);const Y=H<0?"left":"right";B.dataset.side!==Y&&(B.dataset.side=Y),r.current===A.id&&s.current&&x>0&&(s.current.setAttribute("x2",`${(H/x*100).toFixed(2)}`),s.current.setAttribute("y2",`${(z/x*100).toFixed(2)}`))}),Bo(E.map(A=>{const F=A.getBoundingClientRect();return{x:F.left+F.width/2,y:F.top+F.height/2}}))};c.current=v;const k=j=>{v(j),g=requestAnimationFrame(k)},N=()=>{f||h||(f=!0,b=0,g=requestAnimationFrame(k))},C=()=>{f=!1,cancelAnimationFrame(g),un()},S=j=>{const $=p.getBoundingClientRect(),E=(j.clientX-$.left)/$.width-.5,A=(j.clientY-$.top)/$.height-.5;d.style.setProperty("--ry",`${(E*2*kn).toFixed(2)}deg`),d.style.setProperty("--rx",`${(-A*2*kn).toFixed(2)}deg`)},w=()=>{d.style.setProperty("--ry","0deg"),d.style.setProperty("--rx","0deg")},L=new ResizeObserver(()=>{y(),v(performance.now())});L.observe(p);const W=new IntersectionObserver(([j])=>j.isIntersecting?N():C(),{threshold:0});W.observe(p);const D=()=>document.hidden?C():N();return document.addEventListener("visibilitychange",D),h||(p.addEventListener("pointermove",S),p.addEventListener("pointerleave",w)),y(),v(performance.now()),()=>{c.current=null,un(),L.disconnect(),W.disconnect(),document.removeEventListener("visibilitychange",D),p.removeEventListener("pointermove",S),p.removeEventListener("pointerleave",w),C()}},[]),e.jsxs("div",{className:"os-stage",ref:t,"data-active":i?"true":void 0,"aria-hidden":"true",children:[e.jsxs("div",{className:"os-plane",ref:a,children:[wn.map((p,d)=>e.jsx("span",{className:"os-ring",style:{width:`${p.radius*100}%`,height:`${p.radius*100}%`}},d)),e.jsx("svg",{className:"os-link",viewBox:"-100 -100 200 200",preserveAspectRatio:"none",children:e.jsx("line",{ref:s,x1:"0",y1:"0",x2:"0",y2:"0"})}),vn.map((p,d)=>e.jsxs("div",{className:"os-node","data-on":i===p.id?"true":void 0,ref:h=>{n.current[d]=h},children:[e.jsx("span",{className:"os-mark",onPointerEnter:()=>o(p.id),onPointerLeave:()=>o(h=>h===p.id?null:h),children:e.jsx("img",{src:`${Xo}${p.file}`,alt:""})}),e.jsx("span",{className:"os-name",children:p.name})]},p.id))]}),e.jsx("span",{className:"os-core"}),e.jsx("style",{children:`
    ...
    `})]})}function Jo({onEnterGuest:t,onStartTask:a}){const[n,s]=l.useState(""),i=()=>t(n.trim()||void 0);return e.jsxs("div",{children:[e.jsx(m.h1,{initial:{opacity:0,y:12},animate:{opacity:1,y:0},transition:{duration:.6,ease:[.16,1,.3,1]},className:"max-w-[640px] text-[42px] leading-[1.08] font-semibold text-balance text-white sm:text-[56px]",style:{fontFamily:"var(--font-google-sans)"},children:"The world’s leading AI models, working as one for you."}),e.jsx(m.p,{initial:{opacity:0,y:12},animate:{opacity:1,y:0},transition:{duration:.55,delay:.08,ease:[.16,1,.3,1]},className:"mt-5 max-w-[520px] text-[18px] leading-[1.6] tracking-[var(--tracking-body)] text-[var(--color-text-body)]",style:{fontFamily:"var(--font-google-sans)"},children:"Conductor Mode chooses the model that fits each task best."}),e.jsxs(m.div,{"data-presence":"input",initial:{opacity:0,y:16},animate:{opacity:1,y:0},transition:{duration:.55,delay:.15},className:"mt-8 max-w-[600px] rounded-[22px] border border-white/12 bg-white/[0.06] p-4 backdrop-blur-sm transition-colors focus-within:border-white/30",children:[e.jsx("input",{value:n,onChange:o=>s(o.target.value),onKeyDown:o=>{o.key==="Enter"&&i()},placeholder:"Ask anything. Start for free.",className:"w-full bg-transparent text-[16px] text-white placeholder:text-white/35 focus:outline-none",style:{fontFamily:"var(--font-google-sans)"}}),e.jsx("div",{className:"mt-4 flex items-center justify-end",children:e.jsxs("button",{type:"button","data-presence":"cta",onClick:i,className:"flex items-center gap-2 rounded-full bg-[#f84600] px-5 py-2.5 text-[13.5px] font-medium text-white transition-transform hover:scale-[1.03]",style:{fontFamily:"var(--font-google-sans)"},children:["Meet Starchild",e.jsx(J,{className:"size-3.5 rotate-90"})]})})]}),e.jsx(m.div,{initial:{opacity:0},animate:{opacity:1},transition:{duration:.55,delay:.28},className:"mt-6",children:e.jsx(ut,{onStartTask:a,intents:qt})})]})}const Tt=14,er=.14;function La({yieldTo:t=".hero-c"}){const a=l.useRef(null);return l.useEffect(()=>{const n=window.matchMedia("(hover: hover) and (pointer: fine)").matches,s=window.matchMedia("(prefers-reduced-motion: reduce)").matches;if(!n||s)return;const i=document.documentElement;i.classList.add("pd-on");const o=new qe({temperament:"attentive",seed:.37,breath:0});let r=!1,c=0,p=0,d=0;const h=f=>{const u=f.target instanceof Element?f.target:null;p=u!=null&&u.closest(t)?0:1,r||(o.place(f.clientX,f.clientY),r=!0),o.aim(f.clientX,f.clientY)},x=f=>{f.relatedTarget||(p=0)},g=f=>{const u=a.current;u&&r&&(c+=(p-c)*er,u.style.transform=Ot(o.step(f),-Tt/2,-Tt/2),u.style.opacity=`${c}`),d=requestAnimationFrame(g)};return d=requestAnimationFrame(g),window.addEventListener("pointermove",h,{passive:!0}),document.addEventListener("pointerout",x),()=>{cancelAnimationFrame(d),window.removeEventListener("pointermove",h),document.removeEventListener("pointerout",x),i.classList.remove("pd-on")}},[t]),e.jsxs(e.Fragment,{children:[e.jsx("span",{ref:a,className:"pd-dot","aria-hidden":"true"}),e.jsx("style",{children:`
      ...
      `})]})}function Ms({onStartTask:t}){const[a,n]=l.useState(0),s=Cn[a];return e.jsxs("section",{className:"ag-section bg-[#0a0a0a] py-[var(--section-pad)]",children:[e.jsxs(O,{children:[e.jsx("div",{className:"grid grid-cols-12 gap-6",children:e.jsxs("div",{className:"col-span-12 max-w-[52ch]",children:[e.jsx("p",{className:"text-[12px] font-medium tracking-[0.24em] text-white/40 uppercase",style:{fontFamily:"var(--font-google-sans)"},children:"Agents"}),e.jsx("h2",{className:"mt-4 text-[34px] leading-[1.12] font-semibold text-balance text-white sm:text-[44px]",style:{fontFamily:"var(--font-google-sans)"},children:"Let Starchild keep things moving for you."}),e.jsx("p",{className:"mt-5 text-[18px] leading-[1.6] tracking-[var(--tracking-body)] text-balance text-[var(--color-text-body)]",style:{fontFamily:"var(--font-google-sans)"},children:"Ask once. An agent keeps checking, using the tools you connect, and brings you back what matters."})]})}),e.jsxs("div",{className:"mt-14 grid grid-cols-12 items-start gap-6",children:[e.jsxs("div",{className:"col-span-12 flex flex-col gap-2 lg:col-span-4",children:[Cn.map((i,o)=>{const r=o===a;return e.jsx("button",{type:"button",onClick:()=>n(o),"aria-pressed":r,className:`ag-tab${r?" ag-tab--active":""}`,children:e.jsx("span",{className:"ag-tab-title",children:i.label})},i.id)}),e.jsxs("button",{type:"button",onClick:()=>t(s.task),className:"ag-try",children:[s.task.label,e.jsx(J,{className:"size-3.5 rotate-45"})]})]}),e.jsx("div",{className:"col-span-12 lg:col-span-8",children:e.jsx(xr,{story:s})})]})]}),e.jsx("style",{children:`
        .ag-tab {
          display: block; width: 100%; text-align: left; cursor: pointer;
          border: 1px solid transparent; border-left: 2px solid rgba(255,255,255,.12);
      ...
      `})]})}const Rr=9,En=1e3,Wt=.045;function Is(t,a){const n=Math.hypot(t,a);if(n<=1||n>=En)return{x:0,y:0};const s=Math.sqrt(1-n/En)*Rr;return{x:t/n*s,y:a/n*s}}function Ls(){const t=l.useRef(null),a=oe();return l.useEffect(()=>{const n=t.current;if(!n||a)return;const s={at:null},i={x:0,y:0};let o=!1,r=0;const c=()=>{const x=n.getBoundingClientRect(),g=s.at,f=g?Is(g.x-(x.left+x.width/2),g.y-(x.top+x.height/2)):{x:0,y:0};if(i.x+=(f.x-i.x)*Wt,i.y+=(f.y-i.y)*Wt,n.style.transform=`translate3d(${i.x.toFixed(2)}px, ${i.y.toFixed(2)}px, 0)`,Math.abs(f.x-i.x)<.01&&Math.abs(f.y-i.y)<.01){o=!1;return}r=requestAnimationFrame(c)},p=()=>{o||(o=!0,r=requestAnimationFrame(c))},d=x=>{s.at={x:x.clientX,y:x.clientY},p()},h=()=>{s.at=null,p()};return window.addEventListener("pointermove",d,{passive:!0}),window.addEventListener("pointerleave",h),window.addEventListener("scroll",p,{passive:!0}),()=>{window.removeEventListener("pointermove",d),window.removeEventListener("pointerleave",h),window.removeEventListener("scroll",p),cancelAnimationFrame(r)}},[a]),t}const $r=.11,Fr=.72,Wr=26,Pr=.07,In=.05,Ln=180;function Br({stops:t,state:a="resting"}){const n=oe(),s=l.useRef(null),[i,o]=l.useState(!1),r=l.useRef({x:0,y:0,size:0}),c=l.useRef({x:0,y:0,size:0}),p=l.useRef(!1),d=l.useRef(!0),h=l.useRef("1"),x=l.useRef(null),g=l.useRef({x:0,y:0});return l.useEffect(()=>{if(n)return;const f=b=>{x.current={x:b.clientX,y:b.clientY}},u=()=>{x.current=null};return window.addEventListener("pointermove",f,{passive:!0}),window.addEventListener("pointerleave",u),()=>{window.removeEventListener("pointermove",f),window.removeEventListener("pointerleave",u)}},[n]),l.useEffect(()=>{const f=s.current;if(!f)return;const u=()=>{let C=t[0];for(const S of t){const w=(S.zone??S.ref).current;if(!w)continue;const L=window.innerHeight*(S.at??.5);w.getBoundingClientRect().top<=L&&(C=S)}return C},b=C=>{const S=C.ref.current;if(!S)return null;const w=S.getBoundingClientRect();return{x:w.left+w.width/2,y:w.top+w.height/2,size:w.width}};let y=0;const v=C=>{var j;const S=(j=C.clip)==null?void 0:j.current,w=C.ref.current;if(!S||!w)return!0;const L=S.getBoundingClientRect(),W=w.getBoundingClientRect(),D=W.top+W.height/2;return D>L.top&&D<L.bottom},k=()=>{const{x:C,y:S}=g.current,w=c.current.x,L=c.current.y,W=Math.hypot(w,L),D=n?0:Math.min(W/Wr,1)*Pr,j=W>.01?Math.abs(L)/W:0,$=1+D*(1-j)-D*j*.5,E=1+D*j-D*(1-j)*.5;f.style.transform=`translate3d(${r.current.x+C}px, ${r.current.y+S}px, 0) translate(-50%, -50%) scale(${$.toFixed(4)}, ${E.toFixed(4)})`,f.style.setProperty("--flight-scale",String(r.current.size/Ln)),f.style.opacity=d.current?"1":"0",f.style.zIndex=h.current},N=()=>{const C=u();d.current=v(C),h.current=C.above?"6":"1";const S=b(C);if(!S){y=requestAnimationFrame(N);return}if(!n){const w=x.current,L=w?Is(w.x-r.current.x,w.y-r.current.y):{x:0,y:0};g.current.x+=(L.x-g.current.x)*Wt,g.current.y+=(L.y-g.current.y)*Wt}if(!p.current)r.current={...S},c.current={x:0,y:0,size:0},p.current=!0,o(!0);else if(n)r.current={...S};else for(const w of["x","y","size"]){const L=S[w]-r.current[w];c.current[w]=(c.current[w]+L*$r)*Fr,Math.abs(c.current[w])<In&&Math.abs(L)<In?(r.current[w]=S[w],c.current[w]=0):r.current[w]+=c.current[w]}k(),y=requestAnimationFrame(N)};return y=requestAnimationFrame(N),()=>cancelAnimationFrame(y)},[t,n]),e.jsxs("div",{ref:s,"aria-hidden":"true",className:"fo-host",style:{opacity:i?1:0},children:[e.jsx(ba,{size:Ln,state:a}),e.jsx("style",{children:`
        .fo-host {
      ...
      `})}const Vr={mail:e.jsxs(e.Fragment,{children:[e.jsx("rect",{x:"1.8",y:"3.4",width:"12.4",height:"9.2",rx:"1.6"}),e.jsx("path",{d:"m2.4 4.6 5.6 4 5.6-4"})]}),slack:e.jsx("path",{d:"M6.2 2.4v7.4M9.8 6.2v7.4M2.4 9.8h7.4M6.2 6.2h7.4"}),calendar:e.jsxs(e.Fragment,{children:[e.jsx("rect",{x:"2.2",y:"3.2",width:"11.6",height:"10.6",rx:"1.6"}),e.jsx("path",{d:"M2.2 6.5h11.6M5.4 1.8v2.6M10.6 1.8v2.6"})]}),notion:e.jsxs(e.Fragment,{children:[e.jsx("rect",{x:"2.6",y:"2.2",width:"10.8",height:"11.6",rx:"1.6"}),e.jsx("path",{d:"M5.4 5.2v5.6l5.2-5.6v5.6"})]}),telegram:e.jsx("path",{d:"M14.2 2.6 1.9 7.4l3.4 1.2 1.2 3.6 1.9-2.3 3.2 2.4z"}),drive:e.jsx("path",{d:"M6.2 2.2h3.6L14 9.2l-1.8 3.1H3.8L2 9.2z"}),web:e.jsxs(e.Fragment,{children:[e.jsx("circle",{cx:"8",cy:"8",r:"5.9"}),e.jsx("path",{d:"M2.1 8h11.8M8 2.1c1.6 1.7 2.4 3.7 2.4 5.9S9.6 12.2 8 13.9C6.4 12.2 5.6 10.2 5.6 8s.8-4.2 2.4-5.9"})]}),flights:e.jsx("path",{d:"M2.2 9.4 14 5.2l-.9 2.5-7 4.6-1.3-.5 2-2.6-2.4.6z"})};function me({kind:t,className:a=""}){return e.jsx("svg",{viewBox:"0 0 16 16",fill:"none",stroke:"currentColor",strokeWidth:1.4,strokeLinecap:"round",strokeLinejoin:"round",className:a,"aria-hidden":"true",children:Vr[t]})}const gt=[{id:"gmail",name:"Gmail",kind:"mail",what:"Mail",grants:["Read your mail","Draft replies","Send only with your approval"]},{id:"gcal",name:"Google Calendar",kind:"calendar",what:"Calendar",grants:["See your events","Suggest times","Create events with your approval"]},{id:"gdrive",name:"Google Drive",kind:"drive",what:"Files",grants:["Read files you share with it","Create new documents"]},{id:"notion",name:"Notion",kind:"notion",what:"Docs and databases",grants:["Read pages you share","Write to pages you choose"]},{id:"slack",name:"Slack",kind:"slack",what:"Team messages",grants:["Read channels you choose","Post as itself, never as you"]},{id:"telegram",name:"Telegram",kind:"telegram",what:"Messages to you",grants:["Send you messages","Never read your other chats"]},{id:"github",name:"GitHub",kind:"drive",what:"Code and issues",grants:["Read repositories you choose","Comment on issues"]},{id:"jira",name:"Jira",kind:"drive",what:"Tickets",grants:["Read issues","Move and comment with your approval"]},{id:"figma",name:"Figma",kind:"drive",what:"Design files",grants:["Read files you share","Leave comments"]},{id:"salesforce",name:"Salesforce",kind:"web",what:"Customers",grants:["Read records you choose","Update only with your approval"]},{id:"hubspot",name:"HubSpot",kind:"web",what:"Contacts and deals",grants:["Read contacts and deals","Log activity"]},{id:"linkedin",name:"LinkedIn",kind:"web",what:"Your network",grants:["Read your feed and messages","Never post as you"]},{id:"zoom",name:"Zoom",kind:"calendar",what:"Meetings",grants:["See your meetings","Read recordings you share"]},{id:"ms365",name:"Microsoft 365",kind:"mail",what:"Mail and files",grants:["Read your mail and files","Draft, never send"]}],ce=Object.fromEntries(gt.map(t=>[t.id,t])),ya=[{id:"gmail",account:"barbara@starchild.ai",since:"connected in March"},{id:"gcal",account:"barbara@starchild.ai",since:"connected in March"},{id:"notion",account:"Starchild workspace",since:"connected in April"},{id:"slack",account:"Starchild · #general",since:"connected in April"},{id:"telegram",account:"@barbara",since:"connected last week"}],rt=["gmail","gcal","gdrive","notion","slack","telegram"],Fn="52s";function Ur({orbAnchor:t,orbZone:a}={}){const n=oe(),[s,i]=l.useState(null),o=l.useRef(null),r=xt(o,{once:!0,amount:.5}),[c,p]=l.useState(ie||n?rt.length+1:0);l.useEffect(()=>{if(ie||n||!r)return;const h=[window.setTimeout(()=>p(1),120)];return rt.forEach((x,g)=>{h.push(window.setTimeout(()=>p(g+2),520+g*190))}),()=>h.forEach(window.clearTimeout)},[r,n]);const d=c>rt.length;return e.jsxs("section",{className:"co-section",ref:a,children:[e.jsx(O,{children:e.jsxs("div",{className:"co-grid",children:[e.jsxs(m.h2,{...Ke({initial:{opacity:0,y:14},whileInView:{opacity:1,y:0},viewport:{once:!0,amount:.6},transition:{duration:.6,ease:[.16,1,.3,1]}}),className:"co-title",children:["Works with",e.jsx("br",{}),"what you use."]}),e.jsxs("div",{ref:o,className:`co-stage${s||!d?" co-stage--held":""}${ie?" co-stage--still":""}`,onMouseLeave:()=>i(null),children:[e.jsx("svg",{className:"co-wires",viewBox:"0 0 400 400",fill:"none","aria-hidden":"true",children:rt.map((h,x)=>e.jsx("line",{className:`co-wire${c>=x+2?" co-wire--in":""}`,x1:"200",y1:"200",x2:"200",y2:"32",transform:`rotate(${x*60} 200 200)`},h))}),e.jsx("svg",{className:"co-rings",viewBox:"0 0 400 400",fill:"none","aria-hidden":"true",children:[{rx:168,ry:168,rot:0,o:.5},{rx:168,ry:68,rot:-18,o:.34},{rx:168,ry:68,rot:62,o:.34},{rx:168,ry:68,rot:118,o:.28}].map((h,x)=>e.jsx("ellipse",{className:`co-ring${c>=1?" co-ring--in":""}`,style:{transitionDelay:`${x*90}ms`},cx:"200",cy:"200",rx:h.rx,ry:h.ry,transform:`rotate(${h.rot} 200 200)`,stroke:"var(--color-primary)",strokeOpacity:h.o,strokeWidth:"1",strokeDasharray:"2 7"},x))}),e.jsx("div",{ref:t,className:"co-core","aria-hidden":"true",children:(ie||!t)&&e.jsx(pe,{state:s?"listening":"resting",size:112})}),e.jsx("div",{className:"co-spin",children:rt.map((h,x)=>{const g=ce[h],f=s===h;return e.jsx("div",{className:`co-arm${c>=x+2?" co-arm--in":""}`,style:{"--a":`${x*60}deg`},children:e.jsxs("div",{className:"co-hold",children:[e.jsx("button",{type:"button",className:`co-chip${f?" co-chip--on":""}`,onMouseEnter:()=>i(h),onFocus:()=>i(h),onBlur:()=>i(null),"aria-label":g.name,children:e.jsx(me,{kind:g.kind,className:"size-[22px]"})}),e.jsx(X,{children:f&&e.jsxs(m.span,{initial:{opacity:0,y:4},animate:{opacity:1,y:0},exit:{opacity:0,transition:{duration:.12}},transition:{duration:.2,ease:[.16,1,.3,1]},className:"co-tip",children:[e.jsx("strong",{children:g.name}),g.what]})})]})},h)})})]})]})}),e.jsx("style",{children:`
        ...
        .co-spin {
          position: absolute; inset: 0; pointer-events: none;
          animation: co-spin ${Fn} linear infinite;
        }
        .co-arm {
          position: absolute; inset: 0; pointer-events: none;
        ...
        .co-hold {
          ...
          animation: co-unspin ${Fn} linear infinite;
        }
      ...
      `})]})}function Kl({onNavigateHome:t,onLogIn:a,onSignUp:n,onChoosePlan:s}){return e.jsxs("div",{className:"min-h-screen bg-[#050506]",children:[e.jsx(Fa,{onNavigateHome:t,onLogIn:a,onSignUp:n}),e.jsx(Xl,{onChoosePlan:s,standalone:!0})]})}const Zl="abcdefghijklmnopqrstuvwxyz",Yn=32;function Ql({at:t,count:a,onChange:n}){const s=i=>Zl[i].toUpperCase();return e.jsxs("div",{className:"vt-wrap",children:[e.jsx("span",{className:"vt-caption",children:"Landing"}),e.jsxs("div",{className:"vt-track",role:"radiogroup","aria-label":`Landing version ${s(t)}`,style:{width:a*Yn,gridTemplateColumns:`repeat(${a}, 1fr)`},children:[e.jsx("span",{className:"vt-knob","aria-hidden":"true",style:{transform:`translateX(${t*Yn}px)`},children:s(t)}),Array.from({length:a},(i,o)=>e.jsx("button",{type:"button",role:"radio","aria-checked":o===t,"aria-label":`Landing version ${s(o)}`,onClick:()=>n(o),className:`vt-side${o===t?" vt-side--on":""}`,children:s(o)},o))]}),e.jsx("style",{children:`
        .vt-wrap {
    ...
    `})}const Be=[{title:"Give it a job",body:"Tell the agent what you want it to take care of. One standing job, in your own words."},{title:"Connect your tools",body:"It works across the apps you already use — and only the ones you connect."},{title:"Let it keep going",body:"It checks things, runs routines, and carries on after you close the tab."},{title:"Come back when it matters",body:"It reports what it found, and asks first before anything it can't undo."}];function pd({firstTime:t,onCancel:a,onDone:n}){const[s,i]=l.useState(t?"intro":"identity"),[o,r]=l.useState(0),[c,p]=l.useState([]),[d,h]=l.useState(""),[x,g]=l.useState("ember"),[f,u]=l.useState(),b=y=>{u(y.id),d.trim()||h(y.name)};return e.jsxs("div",{className:"ob-stage",children:[e.jsx(X,{mode:"wait",children:e.jsxs(m.div,{initial:{opacity:0,y:10},animate:{opacity:1,y:0},exit:{opacity:0,transition:{duration:.16}},transition:{duration:.38,ease:[.16,1,.3,1]},className:`ob-panel${s==="tools"?" ob-panel--wide":""}`,children:[s==="intro"&&e.jsxs(e.Fragment,{children:[e.jsx("div",{className:"ob-orb",children:e.jsx(de,{status:"working",size:26,halo:!0})}),e.jsx("h1",{className:"ob-h1",children:"Agents work for you over time."}),e.jsx("p",{className:"ob-lede",children:"Give them a job, connect the tools they need, and let them keep things moving even when you're away."}),e.jsx(It,{primary:"Continue",onPrimary:()=>i("how"),onSecondary:a,secondary:"Not now"})]}),s==="how"&&e.jsxs(e.Fragment,{children:[e.jsxs("span",{className:"ob-count",children:[o+1," of ",Be.length]}),e.jsxs("div",{className:"ob-card",children:[e.jsx(od,{i:o}),e.jsx("h2",{className:"ob-h2",children:Be[o].title}),e.jsx("p",{className:"ob-lede",children:Be[o].body})]}),e.jsx(It,{primary:o===Be.length-1?"Continue":"Next",onPrimary:()=>o===Be.length-1?i("tools"):r(o+1),secondary:"Back",onSecondary:()=>o===0?i("intro"):r(o-1)}),e.jsx(gd,{n:Be.length,at:o})]}),s==="tools"&&e.jsxs(e.Fragment,{children:[e.jsx("h2",{className:"ob-h2",children:"Tools this agent can use"}),e.jsx("p",{className:"ob-lede",children:"Connect a tool to Starchild once, then choose which agents may use it. You can change this any time."}),e.jsx(Hs,{enabled:c,onToggle:p}),e.jsx(It,{primary:"Continue",onPrimary:()=>i("identity"),secondary:"Back",onSecondary:()=>i("how")})]}),s==="identity"&&e.jsxs(e.Fragment,{children:[e.jsx("h2",{className:"ob-h2",children:t?"Create your first agent":"Create an agent"}),e.jsx("p",{className:"ob-lede",children:"You can change any of this later."}),e.jsx("div",{className:"ob-preview",style:{"--pick":Ge[x].hex},children:e.jsx("span",{className:"ob-body"})}),e.jsx("div",{className:"ob-picks",children:e.jsx("div",{className:"ob-pick-row",children:Object.entries(Ge).map(([y,v])=>e.jsx("button",{type:"button",onClick:()=>g(y),"aria-label":v.name,"aria-pressed":x===y,className:`ob-swatch${x===y?" ob-swatch--on":""}`,style:{"--pick":v.hex}},y))})}),e.jsx("input",{value:d,onChange:y=>h(y.target.value),className:"ob-input",placeholder:"Name it","aria-label":"Agent name"}),e.jsx("p",{className:"ob-group",children:"Or start from one of these"}),e.jsx("div",{className:"ob-templates",children:_c.map(y=>e.jsxs("button",{type:"button",onClick:()=>b(y),className:`ob-template${f===y.id?" ob-template--on":""}`,children:[e.jsx("span",{className:"ob-template-name",children:y.name}),e.jsx("span",{className:"ob-template-gets",children:y.gets})]},y.id))}),e.jsx(It,{primary:"Create agent",disabled:!d.trim(),onPrimary:()=>n({name:d.trim(),accent:x,tools:c,template:f}),secondary:t?"Back":"Cancel",onSecondary:()=>t?i("tools"):a()})]})]},s+(s==="how"?o:""))}),e.jsx("style",{children:`
      ...
      `})]})}const fd=({agent:t,active:a,nudged:n,onSelect:s,innerRef:i})=>e.jsxs("button",{ref:i,type:"button",onClick:s,className:`ag-row${a?" ag-row--on":""}${n?" ag-row--nudged":""}`,children:[e.jsx("span",{className:"ag-row-orb",style:t.accent?{"--agent-accent":t.accent}:void 0,children:e.jsx(de,{status:t.status,size:8,accent:t.accent})}),e.jsxs("span",{className:"ag-row-body",children:[e.jsxs("span",{className:"ag-row-top",children:[e.jsx("span",{className:"ag-row-name",children:t.name}),e.jsx("span",{className:"ag-row-time",children:t.lastActive})]}),e.jsx("span",{className:"ag-row-mood",children:t.mood})]})]});function md({when:t,lines:a}){return e.jsxs("div",{className:"ag-bubble ag-activity",children:[e.jsx("p",{className:"ag-activity-when",children:t}),e.jsx("ul",{children:a.map(n=>e.jsx("li",{children:n},n))})]})}function ud({text:t,detail:a,confirm:n}){const[s,i]=l.useState(null);return e.jsxs("div",{className:`ag-bubble ag-approval${s?" ag-approval--done":""}`,children:[e.jsx("p",{className:"ag-approval-title",children:t}),e.jsx("p",{className:"ag-approval-detail",children:a}),s?e.jsx("p",{className:"ag-approval-state",children:s==="approved"?"Approved — sending now.":"Held. Nothing was sent."}):e.jsxs("div",{className:"ag-approval-actions",children:[e.jsx("button",{type:"button",onClick:()=>i("approved"),className:"ag-btn ag-btn--go",children:n}),e.jsx("button",{type:"button",onClick:()=>i("held"),className:"ag-btn",children:"Not yet"})]})]})}function bd({name:t,cadence:a,apps:n}){return e.jsxs("div",{className:"ag-bubble ag-summary",children:[e.jsx("p",{className:"ag-summary-lead",children:"You're all set."}),e.jsx("p",{className:"ag-summary-name",children:t}),e.jsx("p",{className:"ag-summary-line",children:a}),e.jsxs("p",{className:"ag-summary-line",children:["Connected to ",n]})]})}function yd({turn:t,onReply:a}){if(t.kind==="activity")return e.jsx(md,{when:t.when,lines:t.lines});if(t.kind==="approval")return e.jsx(ud,{...t});if(t.kind==="summary")return e.jsx(bd,{...t});const n=t.kind==="you";return e.jsx(Bt,{align:n?"right":"left",onReply:()=>a(t.text),children:e.jsx("div",{className:`ag-bubble ag-msg${n?" ag-msg--mine":""}`,children:t.text})})}function wd({focusId:t}={}){const{roster:a,addAgent:n,updateAgent:s,setAgentTools:i}=Ze(),[o,r]=l.useState(()=>{if(typeof window>"u")return!0;if(new URLSearchParams(window.location.search).get("agents")==="empty")return!1;try{return window.localStorage.getItem("starchild.agents.onboarded")==="1"}catch{return!1}}),[c,p]=l.useState(!1),[d,h]=l.useState(!1),x=()=>h(!0),[g,f]=l.useState(t??""),[u,b]=l.useState(!1),[y,v]=l.useState(!1),[k,N]=l.useState(""),[C,S]=l.useState(null),w=a.find(z=>z.id===g)??a[0];l.useEffect(()=>{t&&f(t)},[t]);const L=c||!o&&a.length===0,[W,D]=l.useState(0),j=(z,Y=[],T=Ge.ember.hex)=>{const q={id:`a${Date.now()}`,name:z,role:"Working out its job with you",status:"working",mood:"Just started. Getting its bearings.",resting:`${z} is waiting on you.`,preview:"Say what you want it on",lastActive:"just now",accent:T,onboarding:!0,tools:Y,thread:Yc("Bárbara").map(I=>({kind:"agent",text:I}))};n(q),f(q.id),D(0),v(!1),r(!0);try{window.localStorage.setItem("starchild.agents.onboarded","1")}catch{}},$=z=>{j(z.name,z.tools,Ge[z.accent].hex),p(!1)},E=()=>{const z=k.trim();if(!z||!w)return;N("");const Y={kind:"you",text:z};if(s(w.id,q=>({...q,thread:[...q.thread,Y]})),!w.onboarding)return;const T=W;D(T+1),window.setTimeout(()=>{s(w.id,q=>{const I=T<pa.length?{kind:"agent",text:pa[T]}:{kind:"summary",name:q.name,cadence:"Checks every Monday",apps:"Notion, Google Calendar and Slack"},M=T>=pa.length;return{...q,onboarding:!M,role:M?"Keeps an eye on what you asked for":q.role,mood:M?"Ready. Waiting for Monday.":q.mood,status:M?"scheduled":q.status,cadence:M?"Every Monday at 9:00":q.cadence,thread:[...q.thread,I]}})},900)},A=l.useRef(null),F=l.useRef({}),[B,_]=l.useState(null),[Q,U]=l.useState(null),[Z,H]=l.useState(!1);return l.useEffect(()=>{if(window.matchMedia("(prefers-reduced-motion: reduce)").matches||L||a.length<2)return;const Y=window.setTimeout(()=>{const T=A.current,q=F.current[At.from],I=F.current[At.to];if(!T||!q||!I)return;const M=T.getBoundingClientRect().top,R=V=>V.getBoundingClientRect().top-M+17;_({from:R(q),to:R(I)}),H(!0)},4200);return()=>window.clearTimeout(Y)},[L,a.length]),e.jsxs("div",{className:"ag-workspace",children:[e.jsxs("aside",{className:"ag-list",children:[e.jsxs("div",{className:"ag-list-head",children:[e.jsx("p",{className:"ag-list-title",children:"Agents"}),e.jsx("button",{type:"button",className:"ag-new","aria-label":"Find or create an agent",onClick:x,children:e.jsx(fe,{className:"size-4"})})]}),e.jsxs("div",{className:"ag-rows",ref:A,children:[e.jsx(X,{children:B&&e.jsx(m.span,{className:"ag-signal","aria-hidden":"true",initial:{top:B.from,opacity:0,scale:.5},animate:{top:B.to,opacity:[0,1,1,0],scale:1},transition:{duration:1.15,ease:[.4,0,.2,1],times:[0,.15,.75,1]},onAnimationComplete:()=>{_(null),U(At.to),window.setTimeout(()=>U(null),900)}},"signal")}),a.length===0&&e.jsxs("div",{className:"ag-empty",children:[e.jsx("p",{className:"ag-empty-title",children:"No agents yet."}),e.jsx("p",{className:"ag-empty-body",children:"This is where they'll live, each with its own thread."})]}),a.map(z=>e.jsx(fd,{agent:z,active:z.id===w.id,nudged:Q===z.id,innerRef:Y=>{F.current[z.id]=Y},onSelect:()=>f(z.id)},z.id))]}),e.jsx(X,{children:Z&&e.jsx(m.p,{initial:{opacity:0},animate:{opacity:1},transition:{duration:.6,delay:1.2},className:"ag-handoff-note",children:At.says})})]}),d&&!L&&e.jsx(xd,{roster:a,onPick:z=>{f(z),h(!1)},onCreate:z=>{h(!1),j((z==null?void 0:z.trim())||"New agent")},onClose:()=>h(!1)}),L&&e.jsx(pd,{firstTime:!o&&a.length===0,onCancel:()=>{p(!1),r(!0)},onDone:$}),!L&&!d&&w&&e.jsxs("section",{className:"ag-thread",children:[e.jsx("header",{className:"ag-head",children:e.jsxs("button",{type:"button",className:`ag-id${y?" ag-id--open":""}`,onClick:()=>v(z=>!z),"aria-expanded":y,children:[e.jsx(de,{status:w.status,size:11,halo:!0,accent:w.accent}),e.jsx("span",{className:"ag-head-name",children:w.name}),e.jsx(_e,{className:"ag-id-chev size-3.5"})]})}),e.jsxs(m.div,{initial:{opacity:0},animate:{opacity:1},transition:{duration:.3},className:"ag-turns",children:[w.thread.map((z,Y)=>e.jsx(yd,{turn:z,onReply:S},Y)),e.jsxs(m.p,{initial:{opacity:0},animate:{opacity:1},transition:{duration:.6,delay:.5},className:"ag-resting",children:[e.jsx(de,{status:w.status,size:6}),w.resting]})]},w.id),u&&e.jsxs("div",{className:"ag-sheet",children:[e.jsxs("div",{className:"ag-sheet-head",children:[e.jsxs("p",{className:"ag-sheet-title",children:["Tools ",w.name," can use"]}),e.jsx("button",{type:"button",className:"ag-sheet-close",onClick:()=>b(!1),children:"Done"})]}),e.jsx(Hs,{enabled:w.tools,onToggle:z=>i(w.id,z)})]}),e.jsxs("div",{className:"ag-composer",children:[C&&e.jsxs("div",{className:"ag-quote",children:[e.jsx("p",{children:C}),e.jsx("button",{type:"button",onClick:()=>S(null),"aria-label":"Cancel reply",children:"✕"})]}),e.jsxs("div",{className:"ag-composer-row",children:[e.jsx("input",{value:k,onChange:z=>N(z.target.value),onKeyDown:z=>{z.key==="Enter"&&E()},placeholder:`Message ${w.name}…`,className:"ag-input"}),e.jsx("button",{type:"button",className:"ag-send","aria-label":"Send",onClick:E,children:e.jsx(J,{className:"size-4"})})]})]})]}),e.jsx(X,{children:!L&&!d&&w&&y&&e.jsx(m.aside,{initial:{width:0,opacity:0},animate:{width:316,opacity:1},exit:{width:0,opacity:0},transition:{duration:.34,ease:[.16,1,.3,1]},className:"ag-drawer",children:e.jsxs("div",{className:"ag-drawer-in",children:[e.jsxs("div",{className:"ag-drawer-top",children:[e.jsx("p",{className:"ag-drawer-kicker",children:"Agent"}),e.jsx("button",{type:"button",className:"ag-drawer-x",onClick:()=>v(!1),"aria-label":"Close",children:"✕"})]}),e.jsx("div",{className:"ag-drawer-orb",children:e.jsx(de,{status:w.status,size:34,halo:!0,accent:w.accent})}),e.jsxs("label",{className:"ag-field",children:[e.jsx("span",{className:"ag-field-label",children:"Name"}),e.jsx("input",{className:"ag-field-in",value:w.name,onChange:z=>s(w.id,Y=>({...Y,name:z.target.value}))})]}),e.jsxs("label",{className:"ag-field",children:[e.jsx("span",{className:"ag-field-label",children:"What it does"}),e.jsx("textarea",{className:"ag-field-in",rows:3,value:w.role,onChange:z=>s(w.id,Y=>({...Y,role:z.target.value}))})]}),e.jsxs("div",{className:"ag-field",children:[e.jsx("span",{className:"ag-field-label",children:"Colour"}),e.jsx("div",{className:"ag-swatches",children:Object.entries(Ge).map(([z,Y])=>e.jsx("button",{type:"button","aria-label":Y.name,"aria-pressed":w.accent===Y.hex,onClick:()=>s(w.id,T=>({...T,accent:Y.hex})),className:`ag-swatch${w.accent===Y.hex?" ag-swatch--on":""}`,style:{"--pick":Y.hex}},z))})]}),e.jsxs("div",{className:"ag-field",children:[e.jsx("span",{className:"ag-field-label",children:"Right now"}),e.jsxs("p",{className:`ag-state ag-state--${w.status}`,children:[e.jsx("i",{"aria-hidden":"true"}),Dr[w.status]]}),w.cadence&&e.jsxs("p",{className:"ag-cadence",children:[e.jsx("span",{className:"ag-tick","aria-hidden":"true",children:e.jsx("i",{})}),w.cadence]})]}),e.jsxs("div",{className:"ag-field",children:[e.jsxs("span",{className:"ag-field-head",children:["Connected tools",e.jsx("button",{type:"button",className:"ag-gear","aria-label":"Manage connectors",title:"Manage connectors",onClick:()=>b(!0),children:e.jsx(Ri,{className:"size-[18px]"})})]}),e.jsxs("div",{className:"ag-chips",children:[w.tools.map(z=>e.jsxs("span",{className:"ag-chip",children:[e.jsx(me,{kind:ce[z].kind,className:"size-3.5"}),ce[z].name]},z)),w.tools.length===0&&e.jsx("span",{className:"ag-chip ag-chip--none",children:"Nothing yet"})]})]})]})},"drawer")}),e.jsx("style",{children:`
        .ag-workspace {
